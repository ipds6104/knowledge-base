...
- **2026-07-18**: Menambahkan dokumentasi aturan penyimpanan, penamaan berkas (.zip), serta best practices penataan grup WhatsApp chat (single vs multi-kegiatan) menggunakan tautan relatif pada root README.md.
