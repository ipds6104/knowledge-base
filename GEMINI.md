...
- **2026-07-22**: Membuat dokumen [panduan-sql-lab-fasih-se2026.md](file:///home/ihza/Projects/knowledge-base/kegiatan/sensus-ekonomi-2026/2026/panduan-sql-lab-fasih-se2026.md) yang merinci mekanisme integrasi Superset SQL Lab API, limitasi teknis Superset (`SELECT *` dilarang, max 1000 baris, max 25 kolom, client_id 10-char unik, rate limit 300 req/hari), alur login Playwright SSL BPS, serta kamus data 12 tabel Superset SE2026.
- **2026-07-23**: Membakukan pipeline 2-view SQL Lab SE2026 via CLI `kb sqllab` (subcommand `pull`, `pull-microdata`, `pull-completed`, `report`, `print-prep`, dan `sync`) untuk penarikan data massal Superset BPS. Mengimplementasikan subcommand **`kb sqllab sync`** sebagai SOP tunggal otomatisasi 5-step (Pull Agregat, Pull Microdata 13.500+ Responden Non-Draft & 14.700+ Kuesioner Usaha via 1.000-row chunking, Pull 200 Sub-SLS Completed, Cetak PDF ke `pdf_verifikasi_rt_completed/`, dan Laporan 2-View) agar seluruh data monitoring dan dokumen verifikasi RT selalu fresh dan dapat dijalankan berulang kali secara seamless.
