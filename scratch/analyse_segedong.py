...
def main():
    ...
    # Let's print Table 1
    print("\nTABEL 1: PERBANDINGAN MAKRO KINERJA PML KECAMATAN SEGEDONG")
    print("-" * 125)
    print(f"{'Dimensi Perbandingan':<25} | {'Jamaluddin':<20} | {'Mulyadi':<20} | {'Pitra':<20} | {'Rata-rata Kabupaten':<25}")
    print("-" * 125)
    ...
    def print_row(label, key, is_pct=False, is_daily=False, is_plain_int=False):
        ...
        if key == "target":
            ...
            avg_val = "-"
        print(f"{label:<25} | {vals[0]:<20} | {vals[1]:<20} | {vals[2]:<20} | {avg_val:<25}")
    ...
    print(f"{'Status Bottleneck':<25} | {bottleneck_strs[0]:<20} | {bottleneck_strs[1]:<20} | {bottleneck_strs[2]:<20} | -")
    print("-" * 125)
