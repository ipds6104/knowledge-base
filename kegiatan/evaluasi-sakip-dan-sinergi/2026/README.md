---
nama: "Evaluasi SAKIP dan Sinergi"
kategori: "non-survey"
rutinitas: "rutin"
...
deadlines:
  ...
  - tanggal: "2026-07-31"
    ...
    status: "belum"
  - tanggal: "2026-08-04"
    kegiatan: "Batas Akhir Penelaahan Admin Perencanaan Provinsi/Pusat"
    status: "belum"
  - tanggal: "2026-08-10"
    kegiatan: "Batas Akhir BPS Provinsi Unggah Kertas Kerja TW II ke ESR"
    status: "belum"
---
...
```mermaid
flowchart TD
    A["Operator: Input Realisasi & Analisis"] --> B["Operator: Unggah Undangan, Notula, Daftar Hadir"]
    B --> C["Klik Kirim ke Koordinator"]
    C --> D{"Pemeriksaan Koordinator\n(Indikator)"}
    D -- Ditolak --> A
    D -- Disetujui --> E["Koordinator: Kirim ke Admin"]
    E --> F{"Penelaahan Admin Perencanaan\n(Dokumen & Indikator)"}
    F -- Ditolak --> A
    F -- Disetujui --> G["Operator: Klik PENETAPAN"]
    G --> H["Operator: Unggah Kertas Kerja Excel"]
```
