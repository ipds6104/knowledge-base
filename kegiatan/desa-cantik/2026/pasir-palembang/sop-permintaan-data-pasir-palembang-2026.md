...
| **Jalur 2: Layanan Fasilitasi Cepat** (*Offline & WhatsApp*) | Loket Kantor Desa & WhatsApp Agen Statistik (`+62 857-5171-8089`) | Instansi pemerintah, mahasiswa, perencana, atau pemohon data disagregasi agregat | **15 s.d. 30 Menit** | Lembar Rekapitulasi Data Agregat Terverifikasi Petugas Agen Statistik Desa |
...
3. **Integrasi Open API (Bagi Pengembang / Sistem Eksternal)**:
   - Akses data terbuka terstruktur via REST API (JSON):
     - `https://desa-sm.dvlp.asia/desa-cantik/api/pasirpalembang` (format JSON terstandarisasi untuk integrasi aplikasi).
...
| :---: | :--- | :--- | :---: | :--- |
| **1** | Pemohon Data | Mengajukan kebutuhan data agregat di loket Kantor Desa Pasir Palembang atau via WhatsApp Agen Statistik (`+62 857-5171-8089`). | 5 Menit | Permohonan Tercatat |
