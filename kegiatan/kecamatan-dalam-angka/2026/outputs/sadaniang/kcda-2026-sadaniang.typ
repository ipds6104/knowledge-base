  ...
  header: context {
    if not in_frontmatter.get() and not is_chapter_page.get() {
      ...
      if calc.even(page_num) {
        align(left, text(6.5pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: rgb("#374151"), weight: "bold")[KECAMATAN SADANIANG DALAM ANGKA 2026])
      } else {
...
#align(right)[
  #text(7.5pt)[
    #text(style: "italic")[Katalog/Catalogue:] 1102001.6104080 \
    ISSN: 2477-6777
  ]
]
...
#text(16pt, weight: "bold")[KECAMATAN SADANIANG] \
#v(2pt)
#text(16pt, weight: "bold")[DALAM ANGKA] \
#v(4pt)
#text(11.5pt, style: "italic", fill: rgb("#F5A623"))[Sadaniang District in Figures] \
#v(3pt)
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/_Catalogue_:*], [1102001.6104080],
  [*ISSN:*], [2477-6777],
  [*Nomor Publikasi/_Publication Number_:*], [61040.26007],
  [], [],
...
#text(8pt)[
  Publikasi *Kecamatan Sadaniang Dalam Angka 2026* merupakan seri publikasi tahunan BPS Kabupaten Mempawah yang menyajikan beragam data statistik sektoral bersumber dari instansi pemerintah daerah, kantor camat, desa/kelurahan, serta survei dan sensus BPS. Publikasi ini memuat gambaran umum mengenai geografi, pemerintahan, serta perkembangan kondisi sosial-demografi dan perekonomian di wilayah Kecamatan Sadaniang.
  ...
  #v(5pt)
  Ucapan terima kasih dan penghargaan setinggi-tingginya disampaikan kepada Camat Sadaniang, para Kepala Desa/Lurah se-Kecamatan Sadaniang, serta pimpinan instansi dinas/lembaga atas koordinasi dan kontribusi data yang diberikan dalam penyusunan buku ini.
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Sadaniang Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Sadaniang Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Sadaniang Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Sadaniang Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
