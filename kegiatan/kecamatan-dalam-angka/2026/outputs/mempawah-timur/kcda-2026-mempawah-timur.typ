...
#page(
  ...
  #align(right)[
    #text(7.5pt, fill: rgb("#F3F4F6"))[
      ...
      #text(weight: "bold")[1102001.6104051]
    ]
  ]
  ...
  #align(center)[
    #text(16pt, weight: "bold", fill: white)[KECAMATAN MEMPAWAH TIMUR] \
    #v(2pt)
    #text(15pt, weight: "bold", fill: white)[DALAM ANGKA] \
    #v(4pt)
    #text(11pt, style: "italic", fill: rgb("#F3F4F6"))[Mempawah Timur District in Figures] \
    #v(3pt)
  ...
  #align(center)[
    #rect(
      ...
      #align(center + horizon)[
        ...
        #text(7pt, fill: rgb("#D1D5DB"))[Kecamatan Mempawah Timur Dalam Angka 2026]
      ]
    ]
  ]
...
#align(right)[
  #text(7.5pt)[
    #text(style: "italic")[Katalog/Catalogue:] 1102001.6104051
  ]
]

#v(1fr)

#text(16pt, weight: "bold")[KECAMATAN MEMPAWAH TIMUR] \
#v(2pt)
#text(16pt, weight: "bold")[DALAM ANGKA] \
#v(4pt)
#text(11.5pt, style: "italic", fill: rgb("#F5A623"))[Mempawah Timur District in Figures] \
#v(3pt)
...
#table(
  ...
  [Pasir Wan Salim], [3.824], [10,78],
  [Sungai Bakau Kecil], [7.621], [21,48],
  [Pasir Panjang], [3.721], [10,49],
  [Pasir Palembang], [4.245], [11,97],
  [Pulau Pedalaman], [742], [2,09],
  [Antibar], [8.576], [24,18],
  [Sejegi], [2.604], [7,34],
  [Parit Banjar], [4.140], [11,67]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Status Desa Berdasarkan Indeks Desa Membangun (IDM) di Kecamatan Mempawah Timur, 2024/2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Mempawah Timur Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Satuan Pendidikan Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Mempawah Timur Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Kepala Sekolah dan Guru Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Mempawah Timur Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Peserta Didik Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Mempawah Timur Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
