  ...
  header: context {
    if not in_frontmatter.get() and not is_chapter_page.get() {
      ...
      if calc.even(page_num) {
        align(left, text(6.5pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: rgb("#374151"), weight: "bold")[KECAMATAN MEMPAWAH TIMUR DALAM ANGKA 2026])
      } else {
...
#v(8pt)
#text(10.5pt, weight: "bold")[KECAMATAN MEMPAWAH TIMUR DALAM ANGKA] \
#text(9.5pt, style: "italic")[Mempawah Timur District in Figures] \
#text(9.5pt)[2026] \
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/_Catalogue_:*], [1102001.6104051],
  [*ISSN:*], [2477-6777],
  [*Nomor Publikasi/_Publication Number_:*], [61040.26004],
  [], [],
...
#text(8pt)[
  ...
  #v(5pt)
  Ucapan terima kasih dan penghargaan setinggi-tingginya disampaikan kepada Camat Mempawah Timur, para Kepala Desa/Lurah se-Kecamatan Mempawah Timur, serta pimpinan instansi dinas/lembaga atas koordinasi dan kontribusi data yang diberikan dalam penyusunan buku ini.
