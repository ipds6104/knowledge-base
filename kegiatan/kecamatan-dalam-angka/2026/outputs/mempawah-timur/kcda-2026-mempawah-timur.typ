  ...
  header: context {
    ...
    if has_c and not in_frontmatter.get() and not is_ch {
      ...
      if calc.even(page_num) {
        ...
        align(left, text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: running_title_color, weight: "bold")[KECAMATAN MEMPAWAH TIMUR DALAM ANGKA 2026])
      } else {
    ...
    if not has_c or is_ch {
      ...
      if calc.even(page_num) {
        ...
        grid(
          ...
          text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), style: "italic", fill: running_title_color)[MEMPAWAH TIMUR DISTRICT IN FIGURES 2026]
        )
      } else {
        // Halaman Ganjil (Rekto/Kanan): Judul Bab Bahasa Inggris + Badge No Halaman di kanan (Metropolis, 8pt, running_title_color, italic)
        let right_en_text = if chapter_en != "" { upper(chapter_en) } else { "MEMPAWAH TIMUR DISTRICT IN FIGURES 2026" }
        grid(
          columns: (1fr, auto),
          align: horizon,
          column-gutter: 8pt,
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Mempawah Timur1.jpg", width: 100%, height: 100%)
]
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Mempawah Timur2.jpg", width: 100%, height: 100%)
]
...
#text(10.5pt, weight: "bold", fill: black)[KECAMATAN MEMPAWAH TIMUR DALAM ANGKA 2026] \
#v(1pt)
#text(9pt, style: "italic", fill: black)[MEMPAWAH TIMUR DISTRICT IN FIGURES 2026] \
#v(2pt)
...
#v(9pt)
#text(7.5pt)[
  #text(weight: "bold")[Katalog/Catalogue:] 1102001.6104051
  #v(2pt)
  #text(weight: "bold")[Nomor Publikasi/Publication Number:] 61040.26004
]
...
#align(center)[
  ...
  #v(2pt)
  #text(8.5pt, weight: "bold")[Kecamatan Mempawah Timur Dalam Angka 2026] \
  #text(8pt, style: "italic")[Mempawah Timur District in Figures 2026] \
...
#text(8pt)[
+ Kantor Camat Mempawah Timur/#text(style: "italic")[Mempawah Timur District Office]
...
+ Pemerintah Desa/Kelurahan se-Kecamatan Mempawah Timur/#text(style: "italic")[Village/Subdistrict Administrations throughout Mempawah Timur District]
]
...
#block[
  ...
  #meander.reflow({
    ...
    content[
        ...
        #text(fill: rgb("#EA580C"), weight: "bold")[Publikasi Kecamatan Mempawah Timur Dalam Angka 2026] merupakan seri publikasi tahunan BPS Kabupaten Mempawah yang menyajikan beragam data statistik sektoral bersumber dari instansi pemerintah daerah, kantor camat, desa/kelurahan, serta survei dan sensus BPS. Publikasi ini memuat gambaran umum mengenai geografi, pemerintahan, serta perkembangan kondisi sosial-demografi dan perekonomian di wilayah Kecamatan Mempawah Timur secara menyeluruh.
        ...
        #v(3.5pt)
        Ucapan terima kasih dan penghargaan setinggi-tingginya kami sampaikan kepada Camat Mempawah Timur, para Kepala Desa dan Lurah se-Kecamatan Mempawah Timur, serta pimpinan Organisasi Perangkat Daerah atas koordinasi dan kontribusi data yang diberikan sehingga penyusunan publikasi ini selesai tepat waktu.
...
#block[
  ...
  #meander.reflow({
    ...
    content[
      #text(style: "italic")[
        #text(fill: rgb("#EA580C"), weight: "bold")[Mempawah Timur District in Figures 2026] is an annual publication series issued by BPS-Statistics of Mempawah Regency, presenting various sectoral statistical data sourced from regional government institutions, the subdistrict office, village administrations, as well as surveys and censuses conducted by BPS. This publication provides a comprehensive overview of geography, governance, and socio-demographic and economic development in Mempawah Timur District.
        ...
        #v(3.5pt)
        We would like to express our highest gratitude and appreciation to the Head of Mempawah Timur District, Village Heads throughout Mempawah Timur District, and all collaborating regional agencies for their valuable data contributions and seamless cooperation.
...
#align(center)[
  ...
  #v(2pt)
  #text(9pt, weight: "bold")[Kecamatan Mempawah Timur Dalam Angka 2026] \
  #text(8.5pt, style: "italic")[Mempawah Timur District in Figures 2026] \
  #v(1pt)
  #text(7.5pt)[Volume 48, 2026]
]
...
#toc_entry_item("1.1", "Luas Daerah Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Total Area by Village/Subdistrict in Mempawah Timur District, 2025", get_page_arabic(<tab_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Jarak ke Ibukota Kecamatan dan Ibukota Kabupaten Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Distance to Subdistrict and Regency Capital by Village in Mempawah Timur District, 2025", get_page_arabic(<tab_1_2>))
#v(5pt)
#toc_entry_item("1.3", "Batas Administrasi Kecamatan Mempawah Timur Menurut Arah Mata Angin, 2025", "Administrative Borders of Mempawah Timur District by Cardinal Direction, 2025", get_page_arabic(<tab_1_3>))
#v(5pt)
#toc_entry_item("1.4", "Jarak Kantor Camat Mempawah Timur dengan Kota dan Tempat Penting Lainnya, 2025", "Distance from Mempawah Timur Subdistrict Office to Other Important Places, 2025", get_page_arabic(<tab_1_4>))
#v(5pt)
#toc_entry_item("2.1.1", "Jumlah Dusun, Rukun Warga (RW), dan Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Number of Hamlets, RW, and RT by Village/Subdistrict in Mempawah Timur District, 2025", get_page_arabic(<tab_2_1_1>))
#v(5pt)
#toc_entry_item("2.1.2", "Nama-Nama Camat yang Pernah/Masih Menjabat di Kecamatan Mempawah Timur", "Names of District Heads of Mempawah Timur District", get_page_arabic(<tab_2_1_2>))
#v(5pt)
#toc_entry_item("2.1.3", "Nama-Nama Kepala Desa di Kecamatan Mempawah Timur, 2025", "Names of Village Heads in Mempawah Timur District, 2025", get_page_arabic(<tab_2_1_3>))
#v(5pt)
#toc_entry_item("3.1", "Penduduk, Distribusi Persentase, Kepadatan, dan Rasio Jenis Kelamin Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Population, Percentage Distribution, Density, and Sex Ratio by Village in Mempawah Timur District, 2025", get_page_arabic(<tab_3_1>))
#v(5pt)
#toc_entry_item("4.1.1", "Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2023–2025", "Number of Villages Having Educational Facilities by Level in Mempawah Timur District, 2023–2025", get_page_arabic(<tab_4_1_1>))
#v(5pt)
#toc_entry_item("4.2.1", "Banyaknya Sarana Kesehatan Menurut Jenis Sarana di Kecamatan Mempawah Timur, 2023–2025", "Number of Health Facilities by Type in Mempawah Timur District, 2023–2025", get_page_arabic(<tab_4_2_1>))
#v(5pt)
#toc_entry_item("5.1", "Luas Panen Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis di Kecamatan Mempawah Timur (ha), 2022–2025", "Harvested Area of Vegetables and Seasonal Fruits by Type in Mempawah Timur District (ha), 2022–2025", get_page_arabic(<tab_5_1>))
#v(5pt)
#toc_entry_item("6.1.1", "Keberadaan Sarana Akomodasi Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Accommodation Facilities by Village/Subdistrict in Mempawah Timur District, 2025", get_page_arabic(<tab_6_1_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Lembaga Keuangan Bank Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Banking Financial Institutions by Village/Subdistrict in Mempawah Timur District, 2025", get_page_arabic(<tab_7_1>))
...
#toc_entry_item("1.1", "Jarak dari Desa/Kelurahan ke Ibukota Kecamatan di Kecamatan Mempawah Timur, 2025", "Distance from Village/Subdistrict to District Capital in Mempawah Timur District, 2025", get_page_arabic(<fig_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Luas Wilayah Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Total Area by Village/Subdistrict in Mempawah Timur District, 2025", get_page_arabic(<fig_1_2>))
#v(5pt)
#toc_entry_item("2.1", "Jumlah Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Number of RT by Village in Mempawah Timur District, 2025", get_page_arabic(<fig_2_1>))
#v(5pt)
#toc_entry_item("3.1", "Jumlah Penduduk Menurut Jenis Kelamin di Kecamatan Mempawah Timur, 2025", "Population by Sex in Mempawah Timur District, 2025", get_page_arabic(<fig_3_1>))
#v(5pt)
#toc_entry_item("4.1", "Banyaknya Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2025", "Number of School Facilities by Level in Mempawah Timur District, 2025", get_page_arabic(<fig_4_1>))
#v(5pt)
#toc_entry_item("5.1", "Produksi Tanaman Hortikultura Unggulan di Kecamatan Mempawah Timur, 2025", "Production of Leading Horticulture Crops in Mempawah Timur District, 2025", get_page_arabic(<fig_5_1>))
#v(5pt)
#toc_entry_item("6.1", "Prasarana dan Sarana Komunikasi Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025", "Communication Infrastructure by Village in Mempawah Timur District, 2025", get_page_arabic(<fig_6_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Sarana Perdagangan dan Koperasi Aktif di Kecamatan Mempawah Timur, 2025", "Trading Facilities and Active Cooperatives in Mempawah Timur District, 2025", get_page_arabic(<fig_7_1>))
...
// ==========================================
#text(8.5pt)[
Kecamatan Mempawah Timur secara astronomis dan geografis terletak di wilayah pesisir dan daratan Kabupaten Mempawah, Provinsi Kalimantan Barat dengan ibukota kecamatan berada di Antibar. Wilayah ini terbagi ke dalam 8 desa/kelurahan dengan akses perhubungan darat dan air yang menghubungkan pusat-pusat kegiatan ekonomi lokal dengan ibukota kabupaten.
]
#v(12pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Luas Daerah Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Total Area by Village/Subdistrict in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Pasir Wan Salim], [4,65], [3,86], [Definitif],
  [Sungai Bakau Kecil], [13,38], [11,11], [Indikatif],
  [Pasir Panjang], [6,22], [5,17], [Indikatif],
  [Pasir Palembang], [8,53], [7,09], [Indikatif],
  [Pulau Pedalaman], [0,78], [0,65], [Definitif],
  [Antibar], [39,17], [32,54], [Indikatif],
  [Sejegi], [29,92], [24,85], [Indikatif],
  [Parit Banjar], [17,74], [14,74], [Indikatif],
  [Kecamatan Mempawah Timur/_Total_], [120,39], [100,00], []
)
#v(-2pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jarak ke Ibukota Kecamatan dan Ibukota Kabupaten Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance to Subdistrict and Regency Capital by Village in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Batas Administrasi Kecamatan Mempawah Timur Menurut Arah Mata Angin, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Administrative Borders of Mempawah Timur Subdistrict by Cardinal Direction, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Mempawah Timur/Bagian Tata Pemerintahan Setda Mempawah/#text(style: "italic")[Mempawah Timur District Office/Regional Secretariat Governance Division of Mempawah Regency]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jarak Kantor Camat Mempawah Timur dengan Kota dan Tempat Penting Lainnya, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance from Mempawah Timur Subdistrict Office to Other Important Places, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
// ==========================================
#text(8.5pt)[
Secara administratif, Kecamatan Mempawah Timur terbagi menjadi 8 desa/kelurahan yang dipimpin oleh kepala desa dan lurah definitif, didukung oleh aparatur pemerintah desa, Badan Permusyawaratan Desa (BPD), serta kelembagaan RT dan RW sebagai garda terdepan pelayanan kemasyarakatan.
]
#v(12pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Dusun, Rukun Warga (RW), dan Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Hamlets, RW, and RT by Village/Subdistrict in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Nama-Nama Camat yang Pernah/Masih Menjabat di Kecamatan Mempawah Timur] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of District Heads of Mempawah Timur Subdistrict]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Nama-Nama Kepala Desa/Lurah di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of Village Heads in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Klasifikasi Desa/Kelurahan Perdesaan dan Perkotaan di Kecamatan Mempawah Timur, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Urban and Rural Classification of Village/Subdistrict in Mempawah Timur Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [1], [Pasir Wan Salim], [Kelurahan], [Perkotaan],
  [2], [Sungai Bakau Kecil], [Desa], [Perdesaan],
  [3], [Pasir Panjang], [Desa], [Perkotaan],
  [4], [Pasir Palembang], [Desa], [Perkotaan],
  [5], [Pulau Pedalaman], [Kelurahan], [Perkotaan],
  [6], [Antibar], [Desa], [Perkotaan],
  [7], [Sejegi], [Desa], [Perdesaan],
  [8], [Parit Banjar], [Desa], [Perdesaan]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Status Desa Berdasarkan Indeks Desa Membangun (IDM) di Kecamatan Mempawah Timur, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Mempawah Timur Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [1], [Pasir Wan Salim], [–],
  [2], [Sungai Bakau Kecil], [Mandiri],
  [3], [Pasir Panjang], [Mandiri],
  [4], [Pasir Palembang], [Mandiri],
  [5], [Pulau Pedalaman], [–],
  [6], [Antibar], [Mandiri],
  [7], [Sejegi], [Mandiri],
  [8], [Parit Banjar], [Mandiri]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Pegawai Negeri Sipil Pemerintah Daerah Kecamatan Menurut Golongan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Mempawah Timur Subdistrict Office by Rank/Class, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Pegawai Negeri Sipil Pemerintah Daerah Kecamatan Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Mempawah Timur Subdistrict Office by Education Level, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
// ==========================================
#text(8.5pt)[
Berdasdasarkan data registrasi semester II tahun 2025 dari Dinas Kependudukan dan Pencatatan Sipil Kabupaten Mempawah, jumlah penduduk Kecamatan Mempawah Timur terdistribusi di 8 desa/kelurahan dengan struktur demografi yang produktif. Komposisi penduduk laki-laki dan perempuan relatif berimbang, mencerminkan kestabilan demografis wilayah.
]
#v(12pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Penduduk, Distribusi Persentase, dan Kepadatan Penduduk Menurut Desa/Kelurahan di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Population, Percentage Distribution, and Density by Village/Subdistrict in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Pasir Wan Salim], [1.974], [1.850], [3.824], [10,78], [822,37],
  [Sungai Bakau Kecil], [3.871], [3.750], [7.621], [21,48], [568,73],
  [Pasir Panjang], [1.915], [1.806], [3.721], [10,49], [604,06],
  [Pasir Palembang], [2.165], [2.080], [4.245], [11,97], [497,66],
  [Pulau Pedalaman], [367], [375], [742], [2,09], [951,28],
  [Antibar], [4.286], [4.290], [8.576], [24,18], [218,94],
  [Sejegi], [1.314], [1.290], [2.604], [7,34], [87,03],
  [Parit Banjar], [2.093], [2.047], [4.140], [11,67], [232,85]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Dinas Kependudukan dan Pencatatan Sipil Kabupaten Mempawah (Semester II 2025)/#text(style: "italic")[Population and Civil Registration Service of Mempawah Regency (Semester II 2025)]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages Having Educational Facilities by Educational Level in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Taman Kanak-Kanak (TK)], [5], [6], [...],
  [Raudatul Athfal (RA)], [3], [0], [...],
  [Sekolah Dasar (SD)], [8], [8], [...],
  [Madrasah Ibtidaiyah (MI)], [4], [0], [...],
  [Sekolah Menengah Pertama (SMP)], [4], [6], [...],
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Satuan Pendidikan Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Mempawah Timur Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Taman Kanak-Kanak (TK)1/Kindergarten1], [2], [3], [5],
  [Raudatul Athfal (RA)2], [0], [5], [5],
  [Sekolah Dasar (SD)1], [19], [1], [20],
  [Madrasah Ibtidaiyah], [0], [8], [8],
  [Sekolah Menengah Pertama (SMP)1], [3], [1], [4],
  [Madrasah Tsanawiyah (MTs)2], [0], [7], [7],
  [Sekolah Menengah Atas (SMA)1], [0], [1], [1],
  [Sekolah Menengah Kejuruan (SMK)1], [1], [2], [3],
  [Madrasah Aliyah (MA)2], [1], [4], [5]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Kepala Sekolah dan Pendidik Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Mempawah Timur Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [8], [11], [19],
  [Raudatul Athfal (RA)2], [0], [14], [14],
  [Sekolah Dasar (SD)1,3], [178], [8], [186],
  [Madrasah Ibtidaiyah], [0], [91], [91],
  [Sekolah Menengah], [36], [10], [46],
  [Madrasah], [0], [74], [74],
  [Sekolah Menengah], [0], [6], [6],
  [Sekolah Menengah], [28], [14], [42],
  [Madrasah Aliyah (MA)2], [24], [42], [66]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Peserta Didik Menurut Tingkat Pendidikan di Kecamatan Mempawah Timur, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Mempawah Timur Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [57], [108], [165],
  [Raudatul Athfal (RA)2], [0], [124], [124],
  [Sekolah Dasar (SD)1], [2.351], [83], [2.434],
  [Madrasah Ibtidaiyah], [0], [852], [852],
  [Sekolah Menengah], [394], [57], [451],
  [Madrasah], [0], [866], [866],
  [Sekolah Menengah], [0], [11], [11],
  [Sekolah Menengah], [322], [251], [573],
  [Madrasah Aliyah], [89], [394], [483]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Sarana Kesehatan Menurut Jenis Sarana di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Health Facilities by Type in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Keluarga Menurut Sumber Penerangan Utama di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Families by Main Electricity Source in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Kejadian Bencana Alam Menurut Jenis Bencana di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Natural Disaster Events by Type in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Buah-buahan Utama di Mempawah Timur, 2025 (Kuintal)] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Major Fruits in Mempawah Timur Subdistrict, 2025 (Quintal)]
  ]
)
#v(10pt)
...
// ==========================================
#text(8.5pt)[
Sektor pertanian merupakan salah satu pilar penopang perekonomian masyarakat di Kecamatan Mempawah Timur. Komoditas sayuran semusim, tanaman biofarmaka, serta buah-buahan tahunan dibudidayakan secara intensif oleh rumah tangga petani guna memenuhi kebutuhan pasar domestik dan regional Kabupaten Mempawah.
]
#v(12pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Luas Panen Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis Tanaman di Kecamatan Mempawah Timur, 2022–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Seasonal Vegetables and Fruits by Kind of Plants in Mempawah Timur Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Cabai Besar/TW/Teropong], [13], [1], [...], [...],
  [Cabai Keriting], [...], [...], [...], [...],
  [Cabai Rawit], [48], [56], [7], [24],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [23], [19], [14], [1],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Kacang Panjang/ Long Beans], [4], [25], [27], [19],
  [Kangkung/Water Spinach], [55], [42], [46], [34],
  [Bayam/Spinach], [43], [35], [...], [...],
  [Ketimun/Cucumber], [71], [76], [27], [20],
  [Petsai/Sawi/Chinese Cabbage/], [101], [117], [72], [52],
  [Terung/ Eggplant], [76], [70], [41], [28]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis Tanaman di Kecamatan Mempawah Timur, 2022–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Seasonal Vegetables and Fruits by Kind of Plants in Mempawah Timur Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Bawang Merah/Shallots], [...], [...], [...], [...],
  [Cabai Besar/TW/Teropong], [226], [17], [...], [...],
  [Cabai Keriting], [...], [...], [...], [...],
  [Cabai Rawit], [1164], [1735], [417], [542],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [199], [238], [1021], [25],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Bawang Daun/Scallion], [198], [645], [1261], [495],
  [Kacang Panjang/ Long Beans], [45], [350], [2030], [1610],
  [Kangkung/ Water Spinach], [709], [190], [1257], [860],
  [Bayam/Spinach], [223], [203], [...], [...],
  [Ketimun/Cucumber], [1605], [1205], [799], [865],
  [Petsai/Sawi/ Chinese Cabbage/], [625], [826], [969], [393],
  [Terung/ Eggplant], [1955], [880], [3153], [2031]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-SBS)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-SBS)]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Luas Panen Tanaman Biofarmaka Menurut Jenis Tanaman di Kecamatan Mempawah Timur, 2022–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Medicinal Plants by Kind of Plants in Mempawah Timur Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [670.000], [1.030.000], [1.400.000], [1.020.000],
  [Laos/Lengkuas/Galanga], [10000], [25000], [35000], [35000],
  [Kencur/East Indian Galangal], [20000], [25000], [25000], [30000],
  [Kunyit/Turmeric], [20000], [30000], [65000], [40000],
  [Lidah Buaya/ Aloevera], [100], [...], [...], [...],
  [Jeruk Nipis/ Lime], [10000], [931], [535], [7090],
  [Serai/Lemongrass], [45000], [60000], [70000], [35000]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Tanaman Biofarmaka Menurut Jenis Tanaman di Kecamatan Mempawah Timur, 2022–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Medicinal Plants by Kind of Plants in Mempawah Timur Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [1.755.000], [2.557.000], [3.032.000], [2.267.000],
  [Laos/Lengkuas/Galanga], [3600], [23000], [53640], [71000],
  [Kencur/East Indian Galangal], [6800], [25000], [25000], [25000],
  [Kunyit/Turmeric], [9700], [37500], [64000], [53600],
  [Lidah Buaya/ Aloevera], [50], [...], [...], [...],
  [Jeruk Nipis/ Lime], [60000], [60000], [7500], [71800],
  [Serai/Lemongrass], [135000], [320000], [334000], [160000]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-TBF)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-TBF)]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Buah-Buahan dan Sayuran Tahunan Menurut Jenis Tanaman di Kecamatan Mempawah Timur, 2022–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Annual Fruits and Vegetables by Kind of Plants in Mempawah Timur Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Jenis Tanaman] \ #text(6pt, weight: "bold", style: "italic")[Kind of Plants]], [#strong[2022 (ku)]], [#strong[2023 (ku)]], [#strong[2024 (ku)]], [#strong[2025 (ku)]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]], [#strong[(5)]]),
  [Belimbing/ Star Fruit], [10], [...], [...], [...],
  [Mangga/Mango], [...], [...], [700], [...],
  [Durian/Durian], [...], [...], [800], [...],
  [Jeruk Siam/Keprok/Orange/Tangerine], [330], [...], [...], [...],
  [Pisang/Banana], [133083], [420000], [566183], [233439],
  [Pepaya/Papaya], [2888], [50000], [304500], [...],
  [Salak/Snakefruit], [23], [...], [650], [...],
  [Nanas/ Pineapple], [42.237], [312.000], [212750], [263794],
  [Lengkeng/ Dimocarpus Longan], [10], [20], [220], [...],
  [Sawo/ Sapodilla], [600], [870], [1790], [...]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-BST)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-BST)]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Desa/Kelurahan Menurut Keberadaan Sarana Transportasi Antardesa di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Inter-Village Transportation Infrastructure in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Desa/Kelurahan Menurut Keberadaan Kantor Pos dan Ekspedisi Swasta di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Availability of Post Office and Private Courier in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Menara BTS dan Kekuatan Sinyal Internet Seluler Menurut Desa di Kecamatan Mempawah Timur, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of BTS Towers and Cellular Internet Signal Strength by Village in Mempawah Timur Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
// ==========================================
#text(8.5pt)[
Aktivitas perniagaan di Kecamatan Mempawah Timur berkembang dinamis didukung oleh sarana perdagangan tradisional (pasar dan warung rakyat) serta jaringan minimarket modern. Keberadaan lembaga perbankan, koperasi, dan lembaga keuangan mikro memegang peranan krusial dalam memperluas inklusi keuangan serta akses permodalan bagi usaha mikro, kecil, dan menengah (UMKM).
]
#v(12pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Sarana Perdagangan Menurut Jenis Sarana di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Trade Facilities by Type in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Koperasi Aktif Menurut Jenis Koperasi di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Active Cooperatives by Type in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Lembaga Keuangan Menurut Jenis Lembaga di Kecamatan Mempawah Timur, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Financial Institutions by Type in Mempawah Timur Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/belakang/Mempawah Timur.jpg", width: 100%, height: 100%)
]
