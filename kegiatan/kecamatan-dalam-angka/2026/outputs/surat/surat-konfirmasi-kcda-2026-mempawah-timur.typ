...
#grid(
  ...
  [
    #grid(
      ...
      gutter: 3pt,
      [Nomor], [:], [B-1091/61046/HM.310/2026],
      [Sifat], [:], [Biasa],
...
Sehubungan dengan penyusunan Publikasi Kecamatan Mempawah Timur Dalam Angka 2026, kami bermaksud mengajukan permohonan data nama camat, kepala desa/lurah, kepala dusun, serta profil kepegawaian aparatur sipil negara di lingkungan Pemerintah Kecamatan Mempawah Timur sesuai format terlampir.

Pengisian data dapat dilakukan secara daring melalui tautan lembar kerja berikut: #link("https://s.bps.go.id/kcda26-mptimur")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-mptimur]]. Besar harapan kami data tersebut dapat kami terima selambat-lambatnya pada *Senin, 21 September 2026*. Apabila memerlukan koordinasi lebih lanjut, Bapak/Ibu dapat menghubungi narahubung kami, *Sukma Andini, S.Tr.Stat.* (WhatsApp: *082234120921*).
...
#v(8pt)
#align(center)[
  #text(11pt, weight: "bold")[Lembar Konfirmasi dan Pemutakhiran Data Sektoral \ Kecamatan Mempawah Timur Dalam Angka 2026]
]
#v(6pt)
...
#rect(fill: rgb("#EFF6FF"), stroke: 0.6pt + rgb("#93C5FD"), radius: 3pt, inset: (x: 10pt, y: 6pt))[
  #text(8.5pt)[
    *Petunjuk Pengisian & Konfirmasi Data:*
    ...
    + Pengisian atau konfirmasi data kondisi terkini dilakukan langsung melalui lembar kerja online (*Google Sheets*) pada tautan: #link("https://s.bps.go.id/kcda26-mptimur")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-mptimur]].
...
#table(
  ...
  [7], [*Camat Baru* #text(size: 7.5pt, fill: rgb("#DC2626"))[\ (Tuliskan nama camat baru di sini jika ada pergantian jabatan)]], [2024-],
)
...
#table(
  ...
  [1], [Pasir Wan Salim], [Mulyadi,S.HI], [],
  [2], [Sungai Bakau Kecil], [Saniman], [],
  [3], [Pasir Panjang], [Mukhlis], [],
  [4], [Pasir Palembang], [As’ad Apriadi], [],
  [5], [Pulau Pedalaman], [Sigit Tri Wahyu Utomo,S.STP], [],
  [6], [Antibar], [Julkarnaidi], [],
  [7], [Sejegi], [Herri Gustaman], [],
  [8], [Parit Banjar], [Marlito], [],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 31 { if col == 4 { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [1], [Sungai Bakau Kecil], [Senggiring], [Hairidiansyah], [],
  [], [], [Benteng Raya], [Lily Maulina,S.Kom], [],
  [], [], [Benteng Timur], [Zulmi Ariansyah,S.Pd], [],
  [], [], [Sepakat Tengah], [Ismail], [],
  [], [], [Sepakat Darat], [Kholis], [],
  [], [], [Kedaung], [Abdul Rani Bahari], [],
  [], [], [Senambang], [Haidin], [],
  [], [], [Konsasi], [Samori], [],
  [2], [Pasir Panjang], [Pasir Mandar], [Wandika,S.Pd], [],
  [], [], [Pematang Pasir], [Ramli], [],
  [], [], [Senambang], [Hasan Basri], [],
  [], [], [Terajumas], [-], [],
  [3], [Pasir Palembang], [Pelaik], [Nawari], [],
  [], [], [Tengah], [Saheri], [],
  [], [], [Tekam Baru], [Basis], [],
  [4], [Antibar], [Makmur], [Danu Riandi], [],
  [], [], [Pendidikan], [Yoghan Gianitra], [],
  [], [], [Harapan], [Sugiono], [],
  [], [], [Perman], [Suheri], [],
  [], [], [Satria], [Andi Fauzan], [],
  [], [], [Moton Jaya], [Asmuni], [],
  [], [], [Mekar Jaya], [Tantowi Yahya], [],
  [], [], [Taruna Opu], [Dg Iskandar], [],
  [], [], [Bukti Asam], [Marsudi], [],
  [5], [Sejegi], [Galaherang], [Maehrus Affandi], [],
  [], [], [Bemban], [Suparno], [],
  [], [], [Tekam], [Abdul Rosid], [],
  [6], [Parit Banjar], [Parit Banjar Laut], [Pura'ie], [],
  [], [], [Parit Banjar Tengah], [Abdul Kholiq], [],
  [], [], [Parit Banjar Darat], [Ihya Ulumuddin], [],
  [], [], [Ampulor], [Abdus Syakur], [],
)
