...
// Ditujukan kepada Camat Kecamatan Sungai Kunyit
...
#grid(
  ...
  [
    #grid(
      ...
      gutter: 3pt,
      [Nomor], [:], [B-1094/61046/HM.310/2026],
      [Sifat], [:], [Biasa],
...
#v(10pt)
Yth. *Camat Kecamatan Sungai Kunyit* \
di Tempat
...
Sehubungan dengan penyusunan Publikasi Kecamatan Sungai Kunyit Dalam Angka 2026, kami bermaksud mengajukan permohonan data nama camat, kepala desa/lurah, kepala dusun, serta profil kepegawaian aparatur sipil negara di lingkungan Pemerintah Kecamatan Sungai Kunyit sesuai format terlampir.

Pengisian data dapat dilakukan secara daring melalui tautan lembar kerja berikut: #link("https://s.bps.go.id/kcda26-kunyit")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-kunyit]]. Besar harapan kami data tersebut dapat kami terima selambat-lambatnya pada *Senin, 21 September 2026*. Apabila memerlukan koordinasi lebih lanjut, Bapak/Ibu dapat menghubungi narahubung kami, *Sukma Andini, S.Tr.Stat.* (WhatsApp: *082234120921*).
...
#v(8pt)
#align(center)[
  #text(11pt, weight: "bold")[Lembar Konfirmasi dan Pemutakhiran Data Sektoral \ Kecamatan Sungai Kunyit Dalam Angka 2026]
]
#v(6pt)
...
#rect(fill: rgb("#EFF6FF"), stroke: 0.6pt + rgb("#93C5FD"), radius: 3pt, inset: (x: 10pt, y: 6pt))[
  #text(8.5pt)[
    *Petunjuk Pengisian & Konfirmasi Data:*
    ...
    + Pengisian atau konfirmasi data kondisi terkini dilakukan langsung melalui lembar kerja online (*Google Sheets*) pada tautan: #link("https://s.bps.go.id/kcda26-kunyit")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-kunyit]].
...
#table(
  ...
  [13], [Drs. H. Muchrizal], [2004 – 2006],
  [14], [Sudiono, S.Sos], [2006 – 2007],
  [15], [Drs. Sudjoko, M.Si], [2007 – 2009],
  [16], [Iwan Supardi, S.Sos], [2009 – 2020],
  [17], [Drs. R. Suhartono, M.Si], [2020 – 2022],
  [18], [Drs. M. Erfiza, M.Si], [2022 – 2023],
  [19], [Ir. Teddy Prawoto, M.Si], [2023 – 2024],
  [20], [*Camat Baru* #text(size: 7.5pt, fill: rgb("#DC2626"))[\ (Tuliskan nama camat baru di sini jika ada pergantian jabatan)]], [2024-],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 12 { if col == 3 { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [1], [Semudun], [Wahdah], [],
  [2], [Semparong Parit Raden], [Mujib], [],
  [3], [Mendalok], [Mardianto], [],
  [4], [Sungai Dungun], [Karnain A.], [],
  [5], [Sungai Limau], [Abdul Ghafur, S.Pd.I], [],
  [6], [Sungai Kunyit Laut], [Suhaimi], [],
  [7], [Sungai Kunyit Dalam], [Ardi], [],
  [8], [Sungai Kunyit Hulu], [M. Harun], [],
  [9], [Bukit Batu], [Harianto], [],
  [10], [Sungai Bundung Laut], [H. Rusdiono], [],
  [11], [Sungai Duri I], [Ana Suryana, S.Pd.SD], [],
  [12], [Sungai Duri II], [Langgeng Bayu Irawan, S.Kom], [],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 37 { if col == 4 { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [1], [Semudun], [Dusun Indah], [A. Fahrurrozi, ST], [],
  [], [], [Dusun Permai], [Syukur Findi], [],
  [], [], [Dusun Sejahtera], [Radiati], [],
  [], [], [Dusun Lestari], [Mustahdi], [],
  [2], [Semparong Parit Raden], [Dusun Taufik], [Mahmudin], [],
  [], [], [Dusun Hidayah], [Supriadi], [],
  [], [], [Dusun Palangkeran], [Paisal], [],
  [3], [Mendalok], [Dusun Mandala], [Herman Jasa], [],
  [], [], [Dusun Durian], [Morkan], [],
  [], [], [Dusun Telaga Putih], [Yemin, S.Pd.I], [],
  [4], [Sungai Dungun], [Dusun Satria], [Dobiansyah], [],
  [], [], [Dusun Duta], [Zainab], [],
  [], [], [Dusun Beringin], [Amiril], [],
  [5], [Sungai Limau], [Dusun Nelayan], [Ilham], [],
  [], [], [Dusun Pembangunan], [Muhaddap], [],
  [], [], [Dusun Tani], [Hamdani], [],
  [6], [Sungai Kunyit Laut], [Dusun Sabar], [Zulhairi], [],
  [], [], [Dusun Tenang], [Heriansyah], [],
  [], [], [Dusun Mufakat], [Abdul Ghafur], [],
  [7], [Sungai Kunyit Dalam], [Dusun Melati], [Nurdin], [],
  [], [], [Dusun Mawar], [Budiono], [],
  [], [], [Dusun Cempaka], [Habibi], [],
  [8], [Sungai Kunyit Hulu], [Dusun Sekip I], [Abdul Hakim], [],
  [], [], [Dusun Sekip II], [Muji], [],
  [], [], [Dusun Semayar], [Sy. Sodikin], [],
  [9], [Bukit Batu], [Dusun Karya Utama], [Jarkasih], [],
  [], [], [Dusun Serai Wangi], [Ismail], [],
  [], [], [Dusun Kembang Lada], [Natalis Yoti], [],
  [10], [Sungai Bundung Laut], [Dusun Maya Sari], [Nuraye], [],
  [], [], [Dusun Suka Tani], [Eef Niza], [],
  [], [], [Dusun Tujuh Ratus], [Eko Sabrani], [],
  [11], [Sungai Duri I], [Dusun Sutera], [Wildan Firdaus], [],
  [], [], [Dusun Subur], [Deo Osandi], [],
  [], [], [Dusun Sabar], [Robi Wahyudi], [],
  [12], [Sungai Duri II], [Dusun Karya], [Idris], [],
  [], [], [Dusun Taruna], [Roby], [],
  [], [], [Dusun Damai], [Tabi'i], [],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 13 { if col in (2, 3, 4) { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [1], [Pemerintah Daerah Kecamatan Sungai Kunyit], [], [], [],
  [2], [Semudun], [], [], [],
  [3], [Semparong Parit Raden], [], [], [],
  [4], [Mendalok], [], [], [],
  [5], [Sungai Dungun], [], [], [],
  [6], [Sungai Limau], [], [], [],
  [7], [Sungai Kunyit Laut], [], [], [],
  [8], [Sungai Kunyit Dalam], [], [], [],
  [9], [Sungai Kunyit Hulu], [], [], [],
  [10], [Bukit Batu], [], [], [],
  [11], [Sungai Bundung Laut], [], [], [],
  [12], [Sungai Duri I], [], [], [],
  [13], [Sungai Duri Ii], [], [], [],
)
