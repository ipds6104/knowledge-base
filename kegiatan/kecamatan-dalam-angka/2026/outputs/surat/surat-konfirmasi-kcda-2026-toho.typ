  ...
  header: context {
    ...
    if page_num > 1 {
      grid(
        columns: (1fr, auto),
        align: (left, right),
        text(7pt, fill: rgb("#4B5563"), font: "Myriad Pro")[Lampiran Surat Konfirmasi Data KCDA 2026 | BPS Kabupaten Mempawah - Kecamatan Toho],
...
Dalam rangka pelaksanaan amanat Undang-Undang Nomor 16 Tahun 1997 tentang Statistik dan Peraturan Presiden Nomor 39 Tahun 2019 tentang Satu Data Indonesia, Badan Pusat Statistik (BPS) Kabupaten Mempawah saat ini sedang menyusun publikasi statistik tahunan *"Kecamatan Toho Dalam Angka 2026"*. Publikasi ini menyajikan data statistik sektoral komprehensif tingkat kecamatan dan desa/kelurahan yang menjadi rujukan penting bagi perencanaan, pemantauan, serta evaluasi program pembangunan di Kabupaten Mempawah.

Sehubungan dengan hal tersebut, bersama ini kami sampaikan lembar data acuan (*baseline*) tahun sebelumnya sebagaimana terlampir, yang mencakup data pejabat camat, kepala desa/lurah, kepala dusun, serta profil kepegawaian aparatur sipil negara di lingkungan Kecamatan Toho.
  ...
  #rect(fill: rgb("#F8FAFC"), stroke: 0.8pt + rgb("#CBD5E1"), radius: 4pt, inset: (x: 14pt, y: 8pt))[
    #text(9pt)[
      *Sukma (Sukma Andini, S.Tr.Stat.)* \
      ...
      #link("https://docs.google.com/spreadsheets/d/15VShKwCXs-T5W7UmS1Cw1D3H2CAJiZLEJ3MjXOKfCbk")[#text(size: 8pt, fill: rgb("#1D4ED8"), weight: "bold")[https://docs.google.com/spreadsheets/d/15VShKwCXs-T5W7UmS1Cw1D3H2CAJiZLEJ3MjXOKfCbk]]
    ]
  ]
]
...
#align(center)[
  ...
  #v(2pt)
  #text(10pt, weight: "bold", fill: rgb("#0F294A"))[LEMBAR KONFIRMASI DAN PEMUTAKHIRAN DATA SEKTORAL \ KECAMATAN TOHO DALAM ANGKA 2026]
]
#v(6pt)
