...
// Ditujukan kepada Camat Kecamatan Sadaniang
...
#grid(
  ...
  [
    #grid(
      ...
      gutter: 3pt,
      [Nomor], [:], [B-1100/61046/HM.310/2026],
      [Sifat], [:], [Biasa],
...
Sehubungan dengan penyusunan Publikasi Kecamatan Sadaniang Dalam Angka 2026, kami bermaksud mengajukan permohonan data nama camat, kepala desa/lurah, kepala dusun, serta profil kepegawaian aparatur sipil negara di lingkungan Pemerintah Kecamatan Sadaniang sesuai format terlampir.

Pengisian data dapat dilakukan secara daring melalui tautan lembar kerja berikut: #link("https://s.bps.go.id/kcda26-sadaniang")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-sadaniang]]. Besar harapan kami data tersebut dapat kami terima selambat-lambatnya pada *Senin, 21 September 2026*. Apabila memerlukan koordinasi lebih lanjut, Bapak/Ibu dapat menghubungi narahubung kami, *Sukma Andini, S.Tr.Stat.* (WhatsApp: *082234120921*).
...
#v(8pt)
#align(center)[
  #text(11pt, weight: "bold")[Lembar Konfirmasi dan Pemutakhiran Data Sektoral \ Kecamatan Sadaniang Dalam Angka 2026]
]
#v(6pt)
...
#rect(fill: rgb("#EFF6FF"), stroke: 0.6pt + rgb("#93C5FD"), radius: 3pt, inset: (x: 10pt, y: 6pt))[
  #text(8.5pt)[
    *Petunjuk Pengisian & Konfirmasi Data:*
    ...
    + Pengisian atau konfirmasi data kondisi terkini dilakukan langsung melalui lembar kerja online (*Google Sheets*) pada tautan: #link("https://s.bps.go.id/kcda26-sadaniang")[#text(fill: rgb("#0055D4"), weight: "bold")[https://s.bps.go.id/kcda26-sadaniang]].
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let top_b = if row == 0 { 0.8pt + black } else if row == 6 { red_b } else { norm }
    let bot_b = if row == 0 { 1.2pt + black } else if row == 6 { red_b } else { norm }
    let left_b = if row == 6 and col == 0 { red_b } else { norm }
    let right_b = if row == 6 and col == 2 { red_b } else { norm }
  ...
  [5], [Muhammad Yusra, S.Sos., M.Si.], [2024-2025],
  [6], [*Camat Baru* #text(size: 7.5pt, fill: rgb("#DC2626"))[\ (Tuliskan nama camat baru di sini jika ada pergantian jabatan)]], [],
)
...
#table(
  ...
  [1], [Pentek], [Hendrik], [],
  [2], [Sekabuk], [Andas Saputra, S.Pd.K], [],
  [3], [Bumbun], [Marinus], [],
  [4], [Amawang], [Donisius, A.Md. Kep], [],
  [5], [Ansiap], [Imanuel Yoki, S.Pd], [],
  [6], [Suak Barangan], [Marhasen, S.Pd], [],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 26 { if col == 4 { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [No], [Desa/Kelurahan], [Dusun], [Nama], [],
  [1], [Pentek], [Pentek], [Adrianus], [],
  [2], [Pentek], [Muru], [Dani Ranto Revo Bagaro, SE], [],
  [3], [Pentek], [Untang], [Fx. Jeffry Tumangking], [],
  [4], [Pentek], [Penyuak], [Mersiana Yeti, S.Th], [],
  [5], [Pentek], [Kumpang], [Nokus, S.Pd.K], [],
  [6], [Sekabuk], [Sekabuk], [Teresia Yati], [],
  [7], [Sekabuk], [Gelombang], [Asrianto], [],
  [8], [Sekabuk], [Titidahan], [Ignasius Suardi], [],
  [9], [Sekabuk], [Pak Nungkat], [Ihzar], [],
  [10], [Bumbun], [Bawing], [Bio Datus], [],
  [11], [Bumbun], [Nangka], [Isul], [],
  [12], [Bumbun], [Satak], [Asmanto], [],
  [13], [Bumbun], [Bumbun], [Lipsensius], [],
  [14], [Amawang], [Amawang], [Oktavianus], [],
  [15], [Amawang], [Pudak], [Flavius Akarius], [],
  [16], [Amawang], [Pelanjau], [Niko], [],
  [17], [Amawang], [Pendeng], [Marlina], [],
  [18], [Amawang], [Parong], [Rusni], [],
  [19], [Ansiap], [Tikalong], [Sukiran], [],
  [20], [Ansiap], [Ansiap], [Tiko Riki], [],
  [21], [Ansiap], [Gutok], [Iwan], [],
  [22], [Suak Barangan], [Samantakin], [Erik], [],
  [23], [Suak Barangan], [Guro], [Sugianto], [],
  [24], [Suak Barangan], [Barangan], [Anatimus Usman], [],
  [25], [Suak Barangan], [Parasan], [Marsius], [],
)
...
#table(
  ...
  stroke: (col, row) => {
    ...
    let bot_b = if row == 0 { 1.2pt + black } else if row == 7 { if col in (2, 3, 4) { red_b } else { norm } } else { norm }
    (top: top_b, bottom: bot_b, left: left_b, right: right_b)
  },
  fill: (col, row) => if row == 0 { rgb("#F3F4F6") } else { none },
  table.header(
  ...
  [1], [Pemerintah Daerah Kecamatan Sadaniang], [], [], [],
  [2], [Pentek], [], [], [],
  [3], [Sekabuk], [], [], [],
  [4], [Bum-Bun], [], [], [],
  [5], [Amawang], [], [], [],
