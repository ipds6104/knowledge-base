  ...
  header: context {
    if not in_frontmatter.get() and not is_chapter_page.get() {
      ...
      if calc.even(page_num) {
        align(left, text(6.5pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: rgb("#374151"), weight: "bold")[KECAMATAN JONGKAT DALAM ANGKA 2026])
      } else {
...
#v(8pt)
#text(10.5pt, weight: "bold")[KECAMATAN JONGKAT DALAM ANGKA] \
#text(9.5pt, style: "italic")[Jongkat District in Figures] \
#text(9.5pt)[2026] \
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/_Catalogue_:*], [1102001.6104020],
  [*ISSN:*], [2477-6777],
  [*Nomor Publikasi/_Publication Number_:*], [61040.26008],
  [], [],
...
#text(8pt)[
  ...
  #v(5pt)
  Ucapan terima kasih dan penghargaan setinggi-tingginya disampaikan kepada Camat Jongkat, para Kepala Desa/Lurah se-Kecamatan Jongkat, serta pimpinan instansi dinas/lembaga atas koordinasi dan kontribusi data yang diberikan dalam penyusunan buku ini.
...
#table(
  ...
  [Sungai Nipah], [1,0], [45,3],
  [Jungkat], [1,4], [47,6],
  [Wajok Hilir], [4,9], [51,1],
  [Wajok Hulu], [10,9], [57,2],
  [Peniti Luar], [7,9], [38,4]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Jongkat/#text(style: "italic")[Jongkat District Office]]
#v(8pt)
...
#table(
  ...
  [1], [Ibu Kota Provinsi Kalimantan Barat (Kota Pontianak)], [28,1],
  [2], [Pusat Pemerintahan Kabupaten Mempawah (Mempawah Hilir)], [47,9],
  [3], [Pasar Sungai Pinyuh], [30,4]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Jongkat/#text(style: "italic")[Jongkat District Office]]
#v(8pt)
