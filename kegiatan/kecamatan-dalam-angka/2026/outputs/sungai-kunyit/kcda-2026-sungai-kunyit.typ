...
#text(16pt, weight: "bold")[KECAMATAN SUNGAI KUNYIT] \
#v(2pt)
#text(16pt, weight: "bold")[DALAM ANGKA] \
#v(4pt)
#text(11.5pt, style: "italic", fill: rgb("#F5A623"))[Sungai Kunyit District in Figures] \
#v(3pt)
...
#table(
  ...
  [1], [Ibu Kota Propinsi Kalimantan Barat (Kota Pontianak)], [94,00],
  [2], [Pusat Pemerintahan Kabupaten Mempawah (Mempawah Hilir)], [19,00],
  [3], [Makam Juang Mandor], [66,00],
  [4], [Kecamatan Sungai Pinyuh], [35,00]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Sungai Kunyit/#text(style: "italic")[Sungai Kunyit District Office]]
#v(8pt)
...
#table(
  ...
  [1], [M. Kasim Basok], [1962 – 1963],
  [2], [M. Djamil Achmad], [1963 – 1969],
  [3], [Drs. Uray Roekiyat], [1969 – 1973],
  [4], [Sinyor Mantar], [1973 – 1979],
  [5], [M. Oesman Akad], [1979 – 1981],
  [6], [Drs. Sadri Ilyas], [1981 – 1987],
  [7], [Pahlevie Alhani, BA], [1987 – 1990],
  [8], [Drs. Idrus], [1990 – 1995],
  [9], [Dra. Syarkiah Sani], [1995 – 1999],
  [10], [Drs. Fauzi Kasim], [1999 – 2001],
  [11], [Drs. Nuradi], [2001 – 2002],
  [12], [Bachtiar K, S.Sos], [2002 – 2003]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Sungai Kunyit/#text(style: "italic")[Sungai Kunyit District Office]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Sungai Kunyit Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
