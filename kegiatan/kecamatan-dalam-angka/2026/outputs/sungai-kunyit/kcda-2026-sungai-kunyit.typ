  ...
  header: context {
    ...
    if page_num >= 7 {
      if calc.even(page_num) {
        align(left, text(8pt, fill: rgb("#D97706"), weight: "bold")[KECAMATAN SUNGAI KUNYIT DALAM ANGKA 2026])
      } else {
...
#align(center)[
  ...
  #block(
    ...
    [
      #text(22pt, weight: "bold", fill: rgb("#B45309"))[KECAMATAN SUNGAI KUNYIT] \
      #v(6pt)
      #text(18pt, weight: "bold", fill: rgb("#B45309"))[DALAM ANGKA 2026] \
      #v(10pt)
      #text(13pt, style: "italic", fill: rgb("#92400E"))[Sungai Kunyit Subdistrict in Figures 2026]
    ]
  )
  
  #v(4.0cm)
  #rect(fill: rgb("#F3F4F6"), inset: 8pt, radius: 3pt)[
    #text(8.5pt)[Nomor Publikasi / Publication Number: *61040.26005*]
  ]
...
// ==========================================
#v(1cm)
#text(12pt, weight: "bold")[Kecamatan Sungai Kunyit Dalam Angka 2026] \
#text(10pt, style: "italic")[Sungai Kunyit Subdistrict in Figures 2026]
...
#table(
  ...
  [*Penyusun Naskah / Author*], [Sarah Pratiwi, S.Tr.Stat.],
  [*Pengolah Data / Data Processor*], [Sarah Pratiwi, S.Tr.Stat.],
...
#grid(
  columns: (1fr, 1fr),
  row-gutter: 8pt,
  [1. Kantor Camat Sungai Kunyit], [5. Dinas Pertanian, KP & P Kab. Mempawah],
...
#grid(
  ...
  column-gutter: 18pt,
  [
    Puji syukur ke hadirat Tuhan Yang Maha Kuasa atas terbitnya publikasi *"Kecamatan Sungai Kunyit Dalam Angka 2026"*. Publikasi ini merupakan publikasi tahunan yang menyajikan beragam data statistik dasar dan sektoral mengenai kondisi geografis, pemerintahan, kependudukan, sosial, pertanian, serta perekonomian di tingkat desa/kelurahan se-Kecamatan Sungai Kunyit.
    ...
    Kami menyampaikan penghargaan dan terima kasih yang setinggi-tingginya kepada Camat Sungai Kunyit, kepala desa/lurah, serta seluruh pimpinan instansi atas kerja sama yang baik. Kritik dan saran konstruktif sangat kami harapkan guna penyempurnaan pada edisi mendatang.
  ],
  [
    #text(style: "italic")[
      Praise be to God Almighty for the publication of *"Sungai Kunyit Subdistrict in Figures 2026"*. This annual publication presents a wide range of basic and sectoral statistical data concerning geography, government, population, social, agriculture, and economic conditions across villages in Sungai Kunyit Subdistrict.
      ...
      We express our highest appreciation and gratitude to the Head of Sungai Kunyit Subdistrict, village heads, and agency leaders for their valuable cooperation. Constructive feedback is welcomed for future editions.
    ]
  ]
)
...
=== Tabel 1.1: Luas Daerah Menurut Desa/Kelurahan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 1.1: Total Area by Village/Subdistrict in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 1.2: Jarak ke Ibukota Kecamatan dan Ibukota Kabupaten Menurut Desa/Kelurahan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 1.2: Distance to Subdistrict and Regency Capital by Village in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
#v(-4pt)
#text(7.5pt, fill: luma(80))[*Sumber / Source:* Kantor Camat Sungai Kunyit]
#v(12pt)

#v(10pt)

=== Tabel 1.3: Batas Administrasi Kecamatan Sungai Kunyit Menurut Arah Mata Angin, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 1.3: Administrative Borders of Sungai Kunyit Subdistrict by Cardinal Direction, 2025]
#v(3pt)
#align(center)[
#table(
...
#v(-4pt)
#text(7.5pt, fill: luma(80))[*Sumber / Source:* Kantor Camat Sungai Kunyit / Bagian Tata Pemerintahan Setda Mempawah]
#v(12pt)

#pagebreak()


=== Tabel 1.4: Jarak Kantor Camat Sungai Kunyit dengan Kota dan Tempat Penting Lainnya, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 1.4: Distance from Sungai Kunyit Subdistrict Office to Other Important Places, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 2.1.1: Jumlah Dusun, Rukun Warga (RW), dan Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.1.1: Number of Hamlets, RW, and RT by Village/Subdistrict in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 2.1.2: Nama-Nama Camat yang Pernah/Masih Menjabat di Kecamatan Sungai Kunyit
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.1.2: Names of District Heads of Sungai Kunyit Subdistrict]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 2.1.3: Nama-Nama Kepala Desa/Lurah di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.1.3: Names of Village Heads in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 2.1.6: Status Desa Berdasarkan Indeks Desa Membangun (IDM) di Kecamatan Sungai Kunyit, 2024/2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.1.6: Village Status Based on Developing Village Index (IDM) in Sungai Kunyit Subdistrict, 2024/2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 2.2.1: Jumlah Pegawai Negeri Sipil Pemerintah Daerah Kecamatan Menurut Golongan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.2.1: Number of Civil Servants in Sungai Kunyit Subdistrict Office by Rank/Class, 2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.2fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 2.2.2: Jumlah Pegawai Negeri Sipil Pemerintah Daerah Kecamatan Menurut Tingkat Pendidikan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 2.2.2: Number of Civil Servants in Sungai Kunyit Subdistrict Office by Education Level, 2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.2fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 3.1: Penduduk, Distribusi Persentase, dan Kepadatan Penduduk Menurut Desa/Kelurahan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 3.1: Population, Percentage Distribution, and Density by Village/Subdistrict in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 4.1.1: Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.1.1: Number of Villages Having Educational Facilities by Level in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 4.1.2: Jumlah Satuan Pendidikan Menurut Tingkat Pendidikan di Kecamatan Sungai Kunyit, 2024/2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.1.2: Number of Educational Units by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 4.1.3: Jumlah Kepala Sekolah dan Guru Menurut Tingkat Pendidikan di Kecamatan Sungai Kunyit, 2024/2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.1.3: Number of Principals and Teachers by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.5fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 4.1.4: Jumlah Peserta Didik Menurut Tingkat Pendidikan di Kecamatan Sungai Kunyit, 2024/2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.1.4: Number of Students by Education Level in Sungai Kunyit Subdistrict, 2024/2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.5fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 4.2.1: Banyaknya Sarana Kesehatan Menurut Jenis Sarana di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.2.1: Number of Health Facilities by Type in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.5fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 4.3.1: Banyaknya Keluarga Menurut Sumber Penerangan Utama di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.3.1: Number of Families by Main Electricity Source in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.2fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 4.4.1: Banyaknya Kejadian Bencana Alam Menurut Jenis Bencana di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 4.4.1: Number of Natural Disaster Events by Type in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 5.1: Luas Panen Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis Tanaman di Kecamatan Sungai Kunyit, 2022–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 5.1: Harvested Area of Seasonal Vegetables and Fruits by Kind of Plants in Sungai Kunyit Subdistrict, 2022–2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 5.2: Produksi Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis Tanaman di Kecamatan Sungai Kunyit, 2022–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 5.2: Production of Seasonal Vegetables and Fruits by Kind of Plants in Sungai Kunyit Subdistrict, 2022–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 0.9fr, 0.9fr, 0.9fr, 0.9fr),
...
=== Tabel 5.3: Luas Panen Tanaman Biofarmaka Menurut Jenis Tanaman di Kecamatan Sungai Kunyit, 2022–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 5.3: Harvested Area of Medicinal Plants by Kind of Plants in Sungai Kunyit Subdistrict, 2022–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 0.9fr, 0.9fr, 0.9fr, 0.9fr),
...
=== Tabel 5.4: Produksi Tanaman Biofarmaka Menurut Jenis Tanaman di Kecamatan Sungai Kunyit, 2022–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 5.4: Production of Medicinal Plants by Kind of Plants in Sungai Kunyit Subdistrict, 2022–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 0.9fr, 0.9fr, 0.9fr, 0.9fr),
...
=== Tabel 5.7: Produksi Buah-Buahan dan Sayuran Tahunan Menurut Jenis Tanaman di Kecamatan Sungai Kunyit, 2022–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 5.7: Production of Annual Fruits and Vegetables by Kind of Plants in Sungai Kunyit Subdistrict, 2022–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 0.9fr, 0.9fr, 0.9fr, 0.9fr),
...
=== Tabel 6.1.1: Banyaknya Desa/Kelurahan Menurut Keberadaan Sarana Transportasi Antardesa di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 6.1.1: Number of Villages by Inter-Village Transportation Infrastructure in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 6.2.1: Banyaknya Desa/Kelurahan Menurut Keberadaan Kantor Pos dan Ekspedisi Swasta di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 6.2.1: Number of Villages by Availability of Post Office and Private Courier in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 6.3.1: Banyaknya Menara BTS dan Kekuatan Sinyal Internet Seluler Menurut Desa di Kecamatan Sungai Kunyit, 2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 6.3.1: Number of BTS Towers and Cellular Internet Signal Strength by Village in Sungai Kunyit Subdistrict, 2025]
#v(3pt)
#align(center)[
#table(
...
=== Tabel 7.1: Banyaknya Sarana Perdagangan Menurut Jenis Sarana di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 7.1: Number of Trade Facilities by Type in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 7.2: Banyaknya Koperasi Aktif Menurut Jenis Koperasi di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 7.2: Number of Active Cooperatives by Type in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
  columns: (2.6fr, 1.0fr, 1.0fr, 1.0fr),
...
=== Tabel 7.3: Banyaknya Lembaga Keuangan Menurut Jenis Lembaga di Kecamatan Sungai Kunyit, 2023–2025
#text(8pt, style: "italic", fill: rgb("#92400E"))[Table 7.3: Number of Financial Institutions by Type in Sungai Kunyit Subdistrict, 2023–2025]
#v(3pt)
#align(center)[
#table(
