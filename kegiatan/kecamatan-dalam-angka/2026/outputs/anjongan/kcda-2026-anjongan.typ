  ...
  header: context {
    ...
    if has_c and not in_frontmatter.get() and not is_ch {
      ...
      if calc.even(page_num) {
        ...
        align(left, text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: running_title_color, weight: "bold")[KECAMATAN ANJONGAN DALAM ANGKA 2026])
      } else {
    ...
    if not has_c or is_ch {
      ...
      if calc.even(page_num) {
        ...
        grid(
          ...
          text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), style: "italic", fill: running_title_color)[ANJONGAN DISTRICT IN FIGURES 2026]
        )
      } else {
        // Halaman Ganjil (Rekto/Kanan): Judul Bab Bahasa Inggris + Badge No Halaman di kanan (Metropolis, 8pt, running_title_color, italic)
        let right_en_text = if chapter_en != "" { upper(chapter_en) } else { "ANJONGAN DISTRICT IN FIGURES 2026" }
        grid(
          columns: (1fr, auto),
          align: horizon,
          column-gutter: 8pt,
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Anjongan1.jpg", width: 100%, height: 100%)
]
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Anjongan2.jpg", width: 100%, height: 100%)
]
...
#text(10.5pt, weight: "bold", fill: black)[KECAMATAN ANJONGAN DALAM ANGKA 2026] \
#v(1pt)
#text(9pt, style: "italic", fill: black)[ANJONGAN DISTRICT IN FIGURES 2026] \
#v(2pt)
...
#v(9pt)
#text(7.5pt)[
  #text(weight: "bold")[Katalog/Catalogue:] 1102001.6104041
  #v(2pt)
  #text(weight: "bold")[Nomor Publikasi/Publication Number:] 61040.26009
]
...
#text(8pt)[
+ Kantor Camat Anjongan/#text(style: "italic")[Anjongan District Office]
...
+ Pemerintah Desa/Kelurahan se-Kecamatan Anjongan/#text(style: "italic")[Village/Subdistrict Administrations throughout Anjongan District]
]
...
#block[
  ...
  #meander.reflow({
    ...
    content[
        ...
        #text(fill: rgb("#EA580C"), weight: "bold")[Publikasi Kecamatan Anjongan Dalam Angka 2026] merupakan seri publikasi tahunan BPS Kabupaten Mempawah yang menyajikan beragam data statistik sektoral bersumber dari instansi pemerintah daerah, kantor camat, desa/kelurahan, serta survei dan sensus BPS. Publikasi ini memuat gambaran umum mengenai geografi, pemerintahan, serta perkembangan kondisi sosial-demografi dan perekonomian di wilayah Kecamatan Anjongan secara menyeluruh.
        ...
        #v(3.5pt)
        Ucapan terima kasih dan penghargaan setinggi-tingginya kami sampaikan kepada Camat Anjongan, para Kepala Desa dan Lurah se-Kecamatan Anjongan, serta pimpinan Organisasi Perangkat Daerah atas koordinasi dan kontribusi data yang diberikan sehingga penyusunan publikasi ini selesai tepat waktu.
...
#block[
  ...
  #meander.reflow({
    ...
    content[
      #text(style: "italic")[
        #text(fill: rgb("#EA580C"), weight: "bold")[Anjongan District in Figures 2026] is an annual publication series issued by BPS-Statistics of Mempawah Regency, presenting various sectoral statistical data sourced from regional government institutions, the subdistrict office, village administrations, as well as surveys and censuses conducted by BPS. This publication provides a comprehensive overview of geography, governance, and socio-demographic and economic development in Anjongan District.
        ...
        #v(3.5pt)
        We would like to express our highest gratitude and appreciation to the Head of Anjongan District, Village Heads throughout Anjongan District, and all collaborating regional agencies for their valuable data contributions and seamless cooperation.
...
#align(center)[
  ...
  #v(2pt)
  #text(9pt, weight: "bold")[Kecamatan Anjongan Dalam Angka 2026] \
  #text(8.5pt, style: "italic")[Anjongan District in Figures 2026] \
  #v(1pt)
  #text(7.5pt)[Volume 48, 2026]
]
...
#toc_entry_item("1.1", "Luas Daerah Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Total Area by Village/Subdistrict in Anjongan District, 2025", get_page_arabic(<tab_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Jarak ke Ibukota Kecamatan dan Ibukota Kabupaten Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Distance to Subdistrict and Regency Capital by Village in Anjongan District, 2025", get_page_arabic(<tab_1_2>))
#v(5pt)
#toc_entry_item("1.3", "Batas Administrasi Kecamatan Anjongan Menurut Arah Mata Angin, 2025", "Administrative Borders of Anjongan District by Cardinal Direction, 2025", get_page_arabic(<tab_1_3>))
#v(5pt)
#toc_entry_item("1.4", "Jarak Kantor Camat Anjongan dengan Kota dan Tempat Penting Lainnya, 2025", "Distance from Anjongan Subdistrict Office to Other Important Places, 2025", get_page_arabic(<tab_1_4>))
#v(5pt)
#toc_entry_item("2.1.1", "Jumlah Dusun, Rukun Warga (RW), dan Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Number of Hamlets, RW, and RT by Village/Subdistrict in Anjongan District, 2025", get_page_arabic(<tab_2_1_1>))
#v(5pt)
#toc_entry_item("2.1.2", "Nama-Nama Camat yang Pernah/Masih Menjabat di Kecamatan Anjongan", "Names of District Heads of Anjongan District", get_page_arabic(<tab_2_1_2>))
#v(5pt)
#toc_entry_item("2.1.3", "Nama-Nama Kepala Desa di Kecamatan Anjongan, 2025", "Names of Village Heads in Anjongan District, 2025", get_page_arabic(<tab_2_1_3>))
#v(5pt)
#toc_entry_item("3.1", "Penduduk, Distribusi Persentase, Kepadatan, dan Rasio Jenis Kelamin Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Population, Percentage Distribution, Density, and Sex Ratio by Village in Anjongan District, 2025", get_page_arabic(<tab_3_1>))
#v(5pt)
#toc_entry_item("4.1.1", "Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2023–2025", "Number of Villages Having Educational Facilities by Level in Anjongan District, 2023–2025", get_page_arabic(<tab_4_1_1>))
#v(5pt)
#toc_entry_item("4.2.1", "Banyaknya Sarana Kesehatan Menurut Jenis Sarana di Kecamatan Anjongan, 2023–2025", "Number of Health Facilities by Type in Anjongan District, 2023–2025", get_page_arabic(<tab_4_2_1>))
#v(5pt)
#toc_entry_item("5.1", "Luas Panen Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis di Kecamatan Anjongan (ha), 2022–2025", "Harvested Area of Vegetables and Seasonal Fruits by Type in Anjongan District (ha), 2022–2025", get_page_arabic(<tab_5_1>))
#v(5pt)
#toc_entry_item("6.1.1", "Keberadaan Sarana Akomodasi Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Accommodation Facilities by Village/Subdistrict in Anjongan District, 2025", get_page_arabic(<tab_6_1_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Lembaga Keuangan Bank Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Banking Financial Institutions by Village/Subdistrict in Anjongan District, 2025", get_page_arabic(<tab_7_1>))
...
#toc_entry_item("1.1", "Jarak dari Desa/Kelurahan ke Ibukota Kecamatan di Kecamatan Anjongan, 2025", "Distance from Village/Subdistrict to District Capital in Anjongan District, 2025", get_page_arabic(<fig_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Luas Wilayah Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Total Area by Village/Subdistrict in Anjongan District, 2025", get_page_arabic(<fig_1_2>))
#v(5pt)
#toc_entry_item("2.1", "Jumlah Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Number of RT by Village in Anjongan District, 2025", get_page_arabic(<fig_2_1>))
#v(5pt)
#toc_entry_item("3.1", "Jumlah Penduduk Menurut Jenis Kelamin di Kecamatan Anjongan, 2025", "Population by Sex in Anjongan District, 2025", get_page_arabic(<fig_3_1>))
#v(5pt)
#toc_entry_item("4.1", "Banyaknya Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2025", "Number of School Facilities by Level in Anjongan District, 2025", get_page_arabic(<fig_4_1>))
#v(5pt)
#toc_entry_item("5.1", "Produksi Tanaman Hortikultura Unggulan di Kecamatan Anjongan, 2025", "Production of Leading Horticulture Crops in Anjongan District, 2025", get_page_arabic(<fig_5_1>))
#v(5pt)
#toc_entry_item("6.1", "Prasarana dan Sarana Komunikasi Menurut Desa/Kelurahan di Kecamatan Anjongan, 2025", "Communication Infrastructure by Village in Anjongan District, 2025", get_page_arabic(<fig_6_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Sarana Perdagangan dan Koperasi Aktif di Kecamatan Anjongan, 2025", "Trading Facilities and Active Cooperatives in Anjongan District, 2025", get_page_arabic(<fig_7_1>))
...
#v(-2pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Anjongan/#text(style: "italic")[Anjongan District Office]]
#v(4pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jarak dari Desa/Kelurahan ke Ibukota Kecamatan di Anjongan, 2025 (km)] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance from Village/Subdistrict to District Capital in Anjongan Subdistrict, 2025 (km)]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Luas Wilayah menurut Desa/Kelurahan di Anjongan, 2025 (km²)] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Total Area by Village/Subdistrict in Anjongan Subdistrict, 2025 (sq.km)]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Total Area by Village/Subdistrict in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Anjungan Melancar], [13,91], [11,19], [Indikatif],
  [Anjungan Dalam], [49,99], [40,22], [Indikatif],
  [Pak Bulu], [6,37], [5,13], [Indikatif],
  [Dema], [22,97], [18,48], [Indikatif],
  [Kepayang], [31,04], [24,98], [Indikatif],
  [Kecamatan Anjongan/_Total_], [124,28], [100,00], []
)
#v(-2pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance to Subdistrict and Regency Capital by Village in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Anjungan Melancar], [1,60], [31,20],
  [Anjungan Dalam], [1,90], [31,50],
  [Pak Bulu], [5,40], [37,80],
  [Dema], [11,10], [43,50],
  [Kepayang], [3,10], [35,50]
)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Administrative Borders of Anjongan Subdistrict by Cardinal Direction, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Anjongan/Bagian Tata Pemerintahan Setda Mempawah/#text(style: "italic")[Anjongan District Office/Regional Secretariat Governance Division of Mempawah Regency]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance from Anjongan Subdistrict Office to Other Important Places, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
(Kota Pontianak)], [73,90],
  [2], [Pusat Pemerintahan Kabupaten 
Mempawah (Mempawah Hilir)], [32,80],
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Rukun Tetangga (RT) menurut Desa/Kelurahan di Anjongan, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Neighborhood Units (RT) by Village/Subdistrict in Anjongan Subdistrict, 2025]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Hamlets, RW, and RT by Village/Subdistrict in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Anjungan Melancar], [0], [4], [23],
  [Anjungan Dalam], [2], [2], [11],
  [Pak Bulu], [2], [2], [8],
  [Dema], [3], [3], [12],
  [Kepayang], [4], [4], [18]
)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of District Heads of Anjongan Subdistrict]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [22], [Ferry Ramadhani, S.STP, MAP], [2022 –sekarang]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Anjongan/#text(style: "italic")[Anjongan District Office]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of Village Heads in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Klasifikasi Desa/Kelurahan Perdesaan dan Perkotaan di Kecamatan Anjongan, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Urban and Rural Classification of Village/Subdistrict in Anjongan Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [1], [Anjungan Melancar], [Kelurahan], [Perkotaan],
  [2], [Anjungan Dalam], [Desa], [Perkotaan],
  [3], [Pak Bulu], [Desa], [Perdesaan],
  [4], [Dema], [Desa], [Perkotaan],
  [5], [Kepayang], [Desa], [Perdesaan]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Status Desa Berdasarkan Indeks Desa Membangun (IDM) di Kecamatan Anjongan, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Anjongan Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Anjongan Subdistrict Office by Rank/Class, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Anjongan Subdistrict Office by Education Level, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Penduduk menurut Jenis Kelamin dan Desa/Kelurahan di Anjongan, 2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Population by Sex and Village/Subdistrict in Anjongan Subdistrict, 2025]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Population, Percentage Distribution, and Density by Village/Subdistrict in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages Having Educational Facilities by Educational Level in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Taman Kanak-Kanak (TK)], [4], [4], [...],
  [Raudatul Athfal (RA)], [–], [0], [...],
  [Sekolah Dasar (SD)], [5], [5], [...],
  [Madrasah Ibtidaiyah (MI)], [1], [0], [...],
  [Sekolah Menengah Pertama (SMP)], [3], [3], [...],
  [Madrasah Tsanawiyah (MTs)], [2], [0], [...],
  [Sekolah Menengah Atas (SMA)], [1], [2], [...],
  [Sekolah Menengah Kejuruan (SMK)], [1], [1], [...],
  [Madrasah Aliyah (MA)], [2], [0], [...],
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Satuan Pendidikan Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Anjongan Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Sekolah Dasar (SD)1], [11], [2], [13],
  [Madrasah Ibtidaiyah], [0], [1], [1],
  [Sekolah Menengah Pertama (SMP)1], [3], [2], [5],
  [Madrasah Tsanawiyah (MTs)2], [0], [2], [2],
  [Sekolah Menengah Atas (SMA)1], [1], [0], [1],
  [Sekolah Menengah Kejuruan (SMK)1], [0], [1], [1],
  [Madrasah Aliyah (MA)2], [0], [2], [2]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Kepala Sekolah dan Pendidik Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Anjongan Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [1], [13], [14],
  [Raudatul Athfal (RA)2], [0], [0], [0],
  [Sekolah Dasar (SD)1,3], [143], [13], [156],
  [Madrasah Ibtidaiyah], [0], [35], [35],
  [Sekolah Menengah], [59], [17], [76],
  [Madrasah], [0], [20], [20],
  [Sekolah Menengah], [40], [0], [40],
  [Sekolah Menengah], [0], [6], [6],
  [Madrasah Aliyah (MA)2], [0], [15], [15]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Peserta Didik Menurut Tingkat Pendidikan di Kecamatan Anjongan, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Anjongan Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [17], [160], [177],
  [Raudatul Athfal (RA)2], [0], [0], [0],
  [Sekolah Dasar (SD)1], [1.825], [201], [2.026],
  [Madrasah Ibtidaiyah], [0], [480], [480],
  [Sekolah Menengah], [874], [310], [1.184],
  [Madrasah], [0], [188], [188],
  [Sekolah Menengah], [591], [0], [591],
  [Sekolah Menengah], [0], [32], [32],
  [Madrasah Aliyah], [0], [104], [104]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Health Facilities by Type in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Families by Main Electricity Source in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Natural Disaster Events by Type in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Buah-buahan Utama di Anjongan, 2025 (Kuintal)] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Major Fruits in Anjongan Subdistrict, 2025 (Quintal)]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Seasonal Vegetables and Fruits by Kind of Plants in Anjongan Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Bawang Merah/Shallots], [8], [4], [...], [...],
  [Cabai Besar/TW/Teropong Chili/Big Chili], [13], [23], [8], [23],
  [Cabai Keiting Curly Chili], [...], [...], [...], [...],
  [Cabai Rawit Chili/Cayenne Pepper], [16], [36], [27], [47],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [12], [12], [9], [23],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Bayam/ Spinach], [26], [23], [24], [24],
  [Kacang Panjang/ Long Beans], [47], [45], [40], [12],
  [Semangka/ Watermelon], [16], [27], [21], [39],
  [Melon/ Melon], [...], [...], [...], [...]
)
#v(-3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Seasonal Vegetables and Fruits by Kind of Plants in Anjongan Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Bawang Merah/Shallots], [150], [79], [...], [...],
  [Cabai Besar/TW/Teropong Chili/Big Chili], [272], [394], [841], [375],
  [Cabai Keiting Curly Chili], [...], [...], [...], [...],
  [Cabai Rawit Chili/Cayenne Pepper], [331], [769], [1929], [1094],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [367], [382], [1050], [260],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Bayam/ Spinach], [345], [451], [575], [240],
  [Kacang Panjang/ Long Beans], [916], [871], [2224], [192],
  [Semangka/ Watermelon], [3058], [4185], [3024], [577],
  [Melon/ Melon], [...], [...], [...], [...]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-SBS)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-SBS)]]
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Medicinal Plants by Kind of Plants in Anjongan Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [18.000], [12.000], [18.000], [20.000],
  [Laos/Lengkuas/Galanga], [6000], [9500], [9000], [11000],
  [Kencur/East Indian Galangal], [3000], [4500], [9600], [9000],
  [Kunyit/Turmeric], [5500], [8000], [9500], [9000]
)
#v(-3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Medicinal Plants by Kind of Plants in Anjongan Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [61.750], [36.028], [46.608], [16.000],
  [Laos/Lengkuas/Galanga], [25970], [30330], [15256], [10400],
  [Kencur/East Indian Galangal], [4895], [18900], [19146], [4800],
  [Kunyit/Turmeric], [28600], [37045], [14142], [19200]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-TBF)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-TBF)]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Annual Fruits and Vegetables by Kind of Plants in Anjongan Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Jenis Tanaman] \ #text(6pt, weight: "bold", style: "italic")[Kind of Plants]], [#strong[2022 (ku)]], [#strong[2023 (ku)]], [#strong[2024 (ku)]], [#strong[2025 (ku)]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]], [#strong[(5)]]),
  [Mangga/Mango], [...], [172], [115], [...],
  [Durian/Durian], [470], [124], [502], [1500],
  [Jeruk Siam/Keprok/Orange/Tangerine], [527], [413], [534], [...],
  [Pisang/Banana], [9.438], [2.838], [6.700], [6.067],
  [Pepaya/Papaya], [...], [...], [...], [...],
  [Salak/Snakefruit], [...], [...], [...], [...],
  [Sawo/ Sapodilla/Sawo], [1.467], [671], [329], [116],
  [Rambutan/ Rambutan], [...], [60], [150], [150],
  [Jeruk Besar/ Pomelo], [...], [...], [...], [...],
  [Nangka/Cempedak/ Jackfruit], [1387], [160], [385], [40],
  [Nenas/ Pineapple], [220], [53], [72], [101],
  [Lengkeng/ Dimocarpus Longan], [193], [44], [53], [162],
  [Sukun/ Breadfruit], [1067], [401], [200], [40],
  [Jengkol/ Jengkol], [427], [620], [605], [120]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-BST)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-BST)]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Inter-Village Transportation Infrastructure in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Availability of Post Office and Private Courier in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of BTS Towers and Cellular Internet Signal Strength by Village in Anjongan Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Trade Facilities by Type in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Active Cooperatives by Type in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Financial Institutions by Type in Anjongan Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/belakang/Anjongan.jpg", width: 100%, height: 100%)
]
