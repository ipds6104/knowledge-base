  ...
  header: context {
    if not in_frontmatter.get() and not is_chapter_page.get() {
      ...
      if calc.even(page_num) {
        align(left, text(6.5pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: rgb("#374151"), weight: "bold")[KECAMATAN ANJONGAN DALAM ANGKA 2026])
      } else {
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/_Catalogue_:*], [1102001.6104041],
  [*ISSN:*], [2477-6777],
  [*Nomor Publikasi/_Publication Number_:*], [61040.26009],
  [], [],
...
#text(8pt)[
  ...
  #v(5pt)
  Ucapan terima kasih dan penghargaan setinggi-tingginya disampaikan kepada Camat Anjongan, para Kepala Desa/Lurah se-Kecamatan Anjongan, serta pimpinan instansi dinas/lembaga atas koordinasi dan kontribusi data yang diberikan dalam penyusunan buku ini.
...
#table(
  ...
  [Anjungan Melancar], [1,6], [31,2],
  [Anjungan Dalam], [1,9], [31,5],
  [Pak Bulu], [5,4], [37,8],
  [Dema], [11,1], [43,5],
  [Kepayang], [3,1], [35,5]
)
...
#table(
  ...
  [1], [Ibukota Provinsi Kalimantan Barat (Kota Pontianak)], [73,90],
  [2], [Pusat Pemerintahan Kabupaten Mempawah (Mempawah Hilir)], [32,80],
  [3], [Makam Juang Mandor], [21,50]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Anjongan/#text(style: "italic")[Anjongan District Office]]
#v(8pt)
...
#table(
  ...
  [1], [Tarmizi, S.Sos], [2006 – 2011],
  [2], [Drs. Agit Sugiarto], [2011 – 2017],
  [3], [Firmanto,S.IP. MM (Plt. Camat)], [2017 – 2018],
  [4], [Daeng Dicky], [2018 – 2019],
  [5], [Reno Prawira], [2020 – 2021],
  [6], [Ir. M. Aswan Ghazali, M.Si], [2021–2022],
  [7], [Ferry Ramadhani, S.STP, MAP], [2022 –sekarang]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Anjongan/#text(style: "italic")[Anjongan District Office]]
#v(8pt)
