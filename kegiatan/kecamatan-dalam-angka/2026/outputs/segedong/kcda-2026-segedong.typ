  ...
  #align(center)[
    #rect(
      ...
      #align(center + horizon)[
        ...
        #text(7pt, fill: rgb("#D1D5DB"))[Kecamatan Segedong Dalam Angka 2026]
      ]
    ]
  ]
...
#align(right)[
  #text(7.5pt)[
    #text(style: "italic")[Katalog/Catalogue:] 1102001.6104030
  ]
]

#v(1fr)

#text(16pt, weight: "bold")[KECAMATAN SEGEDONG] \
#v(2pt)
#text(16pt, weight: "bold")[DALAM ANGKA] \
#v(4pt)
#text(11.5pt, style: "italic", fill: rgb("#F5A623"))[Segedong District in Figures] \
#v(3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Segedong Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Segedong Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Segedong Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Segedong Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
