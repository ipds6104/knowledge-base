  ...
  header: context {
    ...
    if has_c and not in_frontmatter.get() and not is_ch {
      ...
      if calc.even(page_num) {
        ...
        align(left, text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: running_title_color, weight: "bold")[KECAMATAN SEGEDONG DALAM ANGKA 2026])
      } else {
    ...
    if not has_c or is_ch {
      ...
      if calc.even(page_num) {
        ...
        grid(
          ...
          text(8pt, font: ("Metropolis", "Liberation Sans", "Arial"), style: "italic", fill: running_title_color)[SEGEDONG DISTRICT IN FIGURES 2026]
        )
      } else {
        // Halaman Ganjil (Rekto/Kanan): Judul Bab Bahasa Inggris + Badge No Halaman di kanan (Metropolis, 8pt, running_title_color, italic)
        let right_en_text = if chapter_en != "" { upper(chapter_en) } else { "SEGEDONG DISTRICT IN FIGURES 2026" }
        grid(
          columns: (1fr, auto),
          align: horizon,
          column-gutter: 8pt,
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Segedong1.jpg", width: 100%, height: 100%)
]
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/depan/Segedong2.jpg", width: 100%, height: 100%)
]
...
#text(10.5pt, weight: "bold", fill: black)[KECAMATAN SEGEDONG DALAM ANGKA 2026] \
#v(1pt)
#text(9pt, style: "italic", fill: black)[SEGEDONG DISTRICT IN FIGURES 2026] \
#v(2pt)
...
#v(9pt)
#text(7.5pt)[
  #text(weight: "bold")[Katalog/Catalogue:] 1102001.6104030
  #v(2pt)
  #text(weight: "bold")[Nomor Publikasi/Publication Number:] 61040.26010
]
...
#text(8pt)[
+ Kantor Camat Segedong/#text(style: "italic")[Segedong District Office]
...
+ Pemerintah Desa/Kelurahan se-Kecamatan Segedong/#text(style: "italic")[Village/Subdistrict Administrations throughout Segedong District]
]
...
#block[
  ...
  #meander.reflow({
    ...
    content[
        ...
        #text(fill: rgb("#EA580C"), weight: "bold")[Publikasi Kecamatan Segedong Dalam Angka 2026] merupakan seri publikasi tahunan BPS Kabupaten Mempawah yang menyajikan beragam data statistik sektoral bersumber dari instansi pemerintah daerah, kantor camat, desa/kelurahan, serta survei dan sensus BPS. Publikasi ini memuat gambaran umum mengenai geografi, pemerintahan, serta perkembangan kondisi sosial-demografi dan perekonomian di wilayah Kecamatan Segedong secara menyeluruh.
        ...
        #v(3.5pt)
        Ucapan terima kasih dan penghargaan setinggi-tingginya kami sampaikan kepada Camat Segedong, para Kepala Desa dan Lurah se-Kecamatan Segedong, serta pimpinan Organisasi Perangkat Daerah atas koordinasi dan kontribusi data yang diberikan sehingga penyusunan publikasi ini selesai tepat waktu.
...
#block[
  ...
  #meander.reflow({
    ...
    content[
      #text(style: "italic")[
        #text(fill: rgb("#EA580C"), weight: "bold")[Segedong District in Figures 2026] is an annual publication series issued by BPS-Statistics of Mempawah Regency, presenting various sectoral statistical data sourced from regional government institutions, the subdistrict office, village administrations, as well as surveys and censuses conducted by BPS. This publication provides a comprehensive overview of geography, governance, and socio-demographic and economic development in Segedong District.
        ...
        #v(3.5pt)
        We would like to express our highest gratitude and appreciation to the Head of Segedong District, Village Heads throughout Segedong District, and all collaborating regional agencies for their valuable data contributions and seamless cooperation.
...
#align(center)[
  ...
  #v(2pt)
  #text(9pt, weight: "bold")[Kecamatan Segedong Dalam Angka 2026] \
  #text(8.5pt, style: "italic")[Segedong District in Figures 2026] \
  #v(1pt)
  #text(7.5pt)[Volume 48, 2026]
]
...
#toc_entry_item("1.1", "Luas Daerah Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Total Area by Village/Subdistrict in Segedong District, 2025", get_page_arabic(<tab_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Jarak ke Ibukota Kecamatan dan Ibukota Kabupaten Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Distance to Subdistrict and Regency Capital by Village in Segedong District, 2025", get_page_arabic(<tab_1_2>))
#v(5pt)
#toc_entry_item("1.3", "Batas Administrasi Kecamatan Segedong Menurut Arah Mata Angin, 2025", "Administrative Borders of Segedong District by Cardinal Direction, 2025", get_page_arabic(<tab_1_3>))
#v(5pt)
#toc_entry_item("1.4", "Jarak Kantor Camat Segedong dengan Kota dan Tempat Penting Lainnya, 2025", "Distance from Segedong Subdistrict Office to Other Important Places, 2025", get_page_arabic(<tab_1_4>))
#v(5pt)
#toc_entry_item("2.1.1", "Jumlah Dusun, Rukun Warga (RW), dan Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Number of Hamlets, RW, and RT by Village/Subdistrict in Segedong District, 2025", get_page_arabic(<tab_2_1_1>))
#v(5pt)
#toc_entry_item("2.1.2", "Nama-Nama Camat yang Pernah/Masih Menjabat di Kecamatan Segedong", "Names of District Heads of Segedong District", get_page_arabic(<tab_2_1_2>))
#v(5pt)
#toc_entry_item("2.1.3", "Nama-Nama Kepala Desa di Kecamatan Segedong, 2025", "Names of Village Heads in Segedong District, 2025", get_page_arabic(<tab_2_1_3>))
#v(5pt)
#toc_entry_item("3.1", "Penduduk, Distribusi Persentase, Kepadatan, dan Rasio Jenis Kelamin Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Population, Percentage Distribution, Density, and Sex Ratio by Village in Segedong District, 2025", get_page_arabic(<tab_3_1>))
#v(5pt)
#toc_entry_item("4.1.1", "Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Segedong, 2023–2025", "Number of Villages Having Educational Facilities by Level in Segedong District, 2023–2025", get_page_arabic(<tab_4_1_1>))
#v(5pt)
#toc_entry_item("4.2.1", "Banyaknya Sarana Kesehatan Menurut Jenis Sarana di Kecamatan Segedong, 2023–2025", "Number of Health Facilities by Type in Segedong District, 2023–2025", get_page_arabic(<tab_4_2_1>))
#v(5pt)
#toc_entry_item("5.1", "Luas Panen Tanaman Sayuran dan Buah-buahan Semusim Menurut Jenis di Kecamatan Segedong (ha), 2022–2025", "Harvested Area of Vegetables and Seasonal Fruits by Type in Segedong District (ha), 2022–2025", get_page_arabic(<tab_5_1>))
#v(5pt)
#toc_entry_item("6.1.1", "Keberadaan Sarana Akomodasi Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Accommodation Facilities by Village/Subdistrict in Segedong District, 2025", get_page_arabic(<tab_6_1_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Lembaga Keuangan Bank Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Banking Financial Institutions by Village/Subdistrict in Segedong District, 2025", get_page_arabic(<tab_7_1>))
...
#toc_entry_item("1.1", "Jarak dari Desa/Kelurahan ke Ibukota Kecamatan di Kecamatan Segedong, 2025", "Distance from Village/Subdistrict to District Capital in Segedong District, 2025", get_page_arabic(<fig_1_1>))
#v(5pt)
#toc_entry_item("1.2", "Luas Wilayah Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Total Area by Village/Subdistrict in Segedong District, 2025", get_page_arabic(<fig_1_2>))
#v(5pt)
#toc_entry_item("2.1", "Jumlah Rukun Tetangga (RT) Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Number of RT by Village in Segedong District, 2025", get_page_arabic(<fig_2_1>))
#v(5pt)
#toc_entry_item("3.1", "Jumlah Penduduk Menurut Jenis Kelamin di Kecamatan Segedong, 2025", "Population by Sex in Segedong District, 2025", get_page_arabic(<fig_3_1>))
#v(5pt)
#toc_entry_item("4.1", "Banyaknya Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Segedong, 2025", "Number of School Facilities by Level in Segedong District, 2025", get_page_arabic(<fig_4_1>))
#v(5pt)
#toc_entry_item("5.1", "Produksi Tanaman Hortikultura Unggulan di Kecamatan Segedong, 2025", "Production of Leading Horticulture Crops in Segedong District, 2025", get_page_arabic(<fig_5_1>))
#v(5pt)
#toc_entry_item("6.1", "Prasarana dan Sarana Komunikasi Menurut Desa/Kelurahan di Kecamatan Segedong, 2025", "Communication Infrastructure by Village in Segedong District, 2025", get_page_arabic(<fig_6_1>))
#v(5pt)
#toc_entry_item("7.1", "Keberadaan Sarana Perdagangan dan Koperasi Aktif di Kecamatan Segedong, 2025", "Trading Facilities and Active Cooperatives in Segedong District, 2025", get_page_arabic(<fig_7_1>))
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Total Area by Village/Subdistrict in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Peniti Dalam I], [123,29], [45,09], [Indikatif],
  [Sungai Burung], [10,14], [3,71], [Indikatif],
  [Sungai Purun Besar], [28,74], [10,51], [Indikatif],
  [Parit Bugis], [7,16], [2,62], [Indikatif],
  [Peniti Besar], [47,74], [17,46], [Indikatif],
  [Peniti Dalam II], [56,39], [20,62], [Indikatif],
  [Kecamatan Segedong/_Total_], [273,45], [100,00], []
)
#v(-2pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance to Subdistrict and Regency Capital by Village in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Peniti Dalam I], [1,40], [43,60],
  [Sungai Burung], [4,70], [34,00],
  [Sungai Purun Besar], [7,90], [30,60],
  [Parit Bugis], [0,75], [39,20],
  [Peniti Besar], [1,90], [40,30],
  [Peniti Dalam II], [4,90], [43,60]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Segedong/#text(style: "italic")[Segedong District Office]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Administrative Borders of Segedong Subdistrict by Cardinal Direction, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Segedong/Bagian Tata Pemerintahan Setda Mempawah/#text(style: "italic")[Segedong District Office/Regional Secretariat Governance Division of Mempawah Regency]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Distance from Segedong Subdistrict Office to Other Important Places, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Hamlets, RW, and RT by Village/Subdistrict in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Peniti Dalam I], [3], [6], [24],
  [Sungai Burung], [2], [2], [9],
  [Sungai Purun Besar], [4], [8], [21],
  [Parit Bugis], [2], [4], [10],
  [Peniti Besar], [7], [15], [36],
  [Peniti Dalam II], [4], [8], [25]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kantor Camat Segedong/#text(style: "italic")[Segedong District Office]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of District Heads of Segedong Subdistrict]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Names of Village Heads in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Klasifikasi Desa/Kelurahan Perdesaan dan Perkotaan di Kecamatan Segedong, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Urban and Rural Classification of Village/Subdistrict in Segedong Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [1], [Peniti Dalam I], [Desa], [Perkotaan],
  [2], [Sungai Burung], [Desa], [Perdesaan],
  [3], [Sungai Purun Besar], [Desa], [Perdesaan],
  [4], [Parit Bugis], [Desa], [Perkotaan],
  [5], [Peniti Besar], [Desa], [Perdesaan],
  [6], [Peniti Dalam II], [Desa], [Perdesaan]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Status Desa Berdasarkan Indeks Desa Membangun (IDM) di Kecamatan Segedong, 2024] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Segedong Subdistrict, 2024]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [1], [Peniti Dalam I], [Mandiri],
  [2], [Sungai Burung], [Mandiri],
  [3], [Sungai Purun Besar], [Mandiri],
  [4], [Parit Bugis], [Mandiri],
  [5], [Peniti Besar], [Mandiri],
  [6], [Peniti Dalam II], [Mandiri]
)
#v(-3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Segedong Subdistrict Office by Rank/Class, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Civil Servants in Segedong Subdistrict Office by Education Level, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Population, Percentage Distribution, and Density by Village/Subdistrict in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Banyaknya Desa/Kelurahan yang Memiliki Fasilitas Sekolah Menurut Tingkat Pendidikan di Kecamatan Segedong, 2023–2025] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages Having Educational Facilities by Educational Level in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Sekolah Menengah Atas (SMA)], [2], [3], [...],
  [Sekolah Menengah Kejuruan (SMK)], [–], [0], [...],
  [Madrasah Aliyah (MA)], [1], [0], [...],
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Satuan Pendidikan Menurut Tingkat Pendidikan di Kecamatan Segedong, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Segedong Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Sekolah Dasar (SD)1], [16], [0], [16],
  [Madrasah Ibtidaiyah], [0], [4], [4],
  [Sekolah Menengah Pertama (SMP)1], [3], [0], [3],
  [Madrasah Tsanawiyah (MTs)2], [0], [3], [3],
  [Sekolah Menengah Atas (SMA)1], [2], [0], [2],
  [Sekolah Menengah Kejuruan (SMK)1], [0], [0], [0],
  [Madrasah Aliyah (MA)2], [0], [1], [1]
)
#v(-3pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Kepala Sekolah dan Pendidik Menurut Tingkat Pendidikan di Kecamatan Segedong, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Segedong Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [4], [5], [9],
  [Raudatul Athfal (RA)2], [0], [0], [0],
  [Sekolah Dasar (SD)1,3], [169], [0], [169],
  [Madrasah Ibtidaiyah], [0], [46], [46],
  [Sekolah Menengah], [45], [0], [45],
  [Madrasah], [0], [19], [19],
  [Sekolah Menengah], [59], [0], [59],
  [Sekolah Menengah], [0], [0], [0],
  [Madrasah Aliyah (MA)2], [0], [13], [13]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Jumlah Peserta Didik Menurut Tingkat Pendidikan di Kecamatan Segedong, 2024/2025–2025/2026] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Segedong Subdistrict, 2024/2025–2025/2026]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Tingkat Pendidikan] \ #text(6pt, weight: "bold", style: "italic")[Educational Level]], [#strong[Negeri] \ #text(6pt, weight: "bold", style: "italic")[Public]], [#strong[Swasta] \ #text(6pt, weight: "bold", style: "italic")[Private]], [#strong[Jumlah] \ #text(6pt, weight: "bold", style: "italic")[Total]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]]),
  [Taman Kanak-Kanak], [49], [53], [102],
  [Raudatul Athfal (RA)2], [0], [0], [0],
  [Sekolah Dasar (SD)1], [2.641], [0], [2.641],
  [Madrasah Ibtidaiyah], [0], [247], [247],
  [Sekolah Menengah], [806], [0], [806],
  [Madrasah], [0], [135], [135],
  [Sekolah Menengah], [957], [0], [957],
  [Sekolah Menengah], [0], [0], [0],
  [Madrasah Aliyah], [0], [39], [39]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi & Kementerian Agama/#text(style: "italic")[Ministry of Education, Culture, Research, and Technology & Ministry of Religious Affairs]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Health Facilities by Type in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Families by Main Electricity Source in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Natural Disaster Events by Type in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    #text(7.5pt, weight: "bold")[Produksi Buah-buahan Utama di Segedong, 2025 (Kuintal)] \
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Major Fruits in Segedong Subdistrict, 2025 (Quintal)]
  ]
)
#v(10pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Seasonal Vegetables and Fruits by Kind of Plants in Segedong Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Cabai Besar/TW/Teropong Chili/Big Chili], [...], [10], [...], [...],
  [Cabai Keiting Curly Chili], [...], [...], [...], [...],
  [Cabai Rawit Chili/Cayenne Pepper], [29], [20], [16], [13],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [12], [15], [10], [5],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Kacang Panjang/Long Beans], [10], [7], [8], [2],
  [Kangkung/Water Spinach], [11], [8], [6], [6],
  [Ketimun/Cucumber], [13], [8], [16], [9],
  [Petsai/Sawi/Chinese Cabbage/Mustard Green], [17], [11], [8], [10],
  [Terung/Eggplant], [9], [10], [5], [3],
  [Bayam/Spinach], [4], [1], [3], [1],
  [Bawang Daun/Scallion], [27], [20], [10], [8],
  [Semangka/Water Melon], [17], [16], [6], [7]
)
#v(-3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Seasonal Vegetables and Fruits by Kind of Plants in Segedong Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Bawang Merah/Shallots], [...], [...], [...], [...],
  [Cabai Besar/TW/Teropong Chili/Big Chili], [...], [80], [...], [...],
  [Cabai Keiting Curly Chili], [...], [...], [...], [...],
  [Cabai Rawit Chili/Cayenne Pepper], [191], [158], [943], [709],
  [Kentang/Potato], [...], [...], [...], [...],
  [Kubis/Cabbage], [...], [...], [...], [...],
  [Tomat/Tomato], [35], [1016], [667], [490],
  [Bawang Putih/Garlic], [...], [...], [...], [...],
  [Kacang Panjang/Long Beans], [86], [101], [443], [200],
  [Kangkung/Water Spinach], [133], [232], [186], [245],
  [Ketimun/Cucumber], [152], [300], [1094], [854],
  [Petsai/Sawi/Chinese Cabbage/Mustard Green], [167], [222], [380], [545],
  [Terung/Eggplant], [74], [200], [364], [384],
  [Bayam/Spinach], [38], [40], [79], [30],
  [Bawang Daun/Scallion], [132], [358], [499], [370],
  [Semangka/Water Melon], [2540], [1803], [326], [698]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-SBS)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-SBS)]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Harvested Area of Medicinal Plants by Kind of Plants in Segedong Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [2.500], [106.500], [...], [3.000],
  [Laos/Lengkuas/Galanga], [2650], [1000], [...], [...],
  [Kencur/East Indian Galangal], [...], [4000], [...], [1500],
  [Kunyit/Turmeric], [4000], [5000], [...], [...]
)
#v(-3pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Medicinal Plants by Kind of Plants in Segedong Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  [Jahe/Ginger], [600], [399.375], [...], [9.000],
  [Laos/Lengkuas/Galanga], [954], [2500], [...], [...],
  [Kencur/East Indian Galangal], [...], [4000], [...], [3500],
  [Kunyit/Turmeric], [1720], [6000], [...], [...]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-TBF)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-TBF)]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Production of Annual Fruits and Vegetables by Kind of Plants in Segedong Subdistrict, 2022–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
#table(
  ...
  table.header([#strong[Jenis Tanaman] \ #text(6pt, weight: "bold", style: "italic")[Kind of Plants]], [#strong[2022 (ku)]], [#strong[2023 (ku)]], [#strong[2024 (ku)]], [#strong[2025 (ku)]], [#strong[(1)]], [#strong[(2)]], [#strong[(3)]], [#strong[(4)]], [#strong[(5)]]),
  [Mangga/Mango], [31.149], [9.497], [12.631], [13170],
  [Durian/Durian], [20.445], [5.252], [7.488], [6324],
  [Jeruk Siam/Keprok/Orange/Tangerine], [42.720], [38.448], [17.429], [19.861],
  [Pisang/Banana], [23.518], [12.149], [8.889], [12.896],
  [Pepaya/Papaya], [5370], [758], [885], [2185],
  [Salak/Snakefruit], [3000], [1667], [731], [778],
  [Sawo/ Sapodilla/Sawo], [9.044], [7.583], [2.811], [2445],
  [Rambutan/ Rambutan], [9.770], [8.160], [3511], [3720],
  [Duku/Langsat/Kokosan/Duku], [30036], [25560], [15801], [3982],
  [Nangka/Cempedak/ Jackfruit], [7565], [5395], [2811], [2767],
  [Nenas/ Pineapple], [2.719], [258], [1.573], [744],
  [Jambu Biji/Guava], [3695], [3094], [1391], [1230],
  [Sukun/ Breadfruit], [5940], [5013], [2274], [2595],
  [Jengkol/ Jengkol], [900], [900], [587], [552],
  [Petai/Twisted Cluster Bean], [1131], [952], [537], [410],
  [Melinjo/Gnetum], [236], [201], [119], [123]
)
#v(-3pt)
#text(6.5pt, fill: luma(60))[Sumber/#text(style: "italic")[Source] : BPS - Kementerian Pertanian, Survei Pertanian Hortikultura (SPH-BST)/#text(style: "italic")[BPS-Statistics Indonesia - Ministry of Agriculture, Horticultural Agricultural Survey (SPH-BST)]]
#v(8pt)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Inter-Village Transportation Infrastructure in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Villages by Availability of Post Office and Private Courier in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of BTS Towers and Cellular Internet Signal Strength by Village in Segedong Subdistrict, 2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Trade Facilities by Type in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Active Cooperatives by Type in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Financial Institutions by Type in Segedong Subdistrict, 2023–2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#page(
  ...
  #image("/kegiatan/kecamatan-dalam-angka/2026/assets/covers/belakang/Segedong.jpg", width: 100%, height: 100%)
]
