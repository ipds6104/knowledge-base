  ...
  header: context {
    if not in_frontmatter.get() and not is_chapter_page.get() {
      ...
      if calc.even(page_num) {
        align(left, text(6.5pt, font: ("Metropolis", "Liberation Sans", "Arial"), fill: rgb("#374151"), weight: "bold")[KECAMATAN SUNGAI PINYUH DALAM ANGKA 2026])
      } else {
...
#page(
  ...
  #align(right)[
    #text(7.5pt, fill: rgb("#F3F4F6"))[
      ...
      #text(weight: "bold")[1102001.6104040] \
  ...
  #align(center)[
    #text(16pt, weight: "bold", fill: white)[KECAMATAN SUNGAI PINYUH] \
    #v(2pt)
    #text(15pt, weight: "bold", fill: white)[DALAM ANGKA] \
    #v(4pt)
    #text(11pt, style: "italic", fill: rgb("#F3F4F6"))[Sungai Pinyuh District in Figures] \
    #v(3pt)
...
#align(right)[
  #text(7.5pt)[
    #text(style: "italic")[Katalog/Catalogue:] 1102001.6104040 \
    ISSN: 2477-6777
  ]
]
...
#text(16pt, weight: "bold")[KECAMATAN SUNGAI PINYUH] \
#v(2pt)
#text(16pt, weight: "bold")[DALAM ANGKA] \
#v(4pt)
#text(11.5pt, style: "italic", fill: rgb("#F5A623"))[Sungai Pinyuh District in Figures] \
#v(3pt)
...
#v(8pt)
#text(10.5pt, weight: "bold")[KECAMATAN SUNGAI PINYUH DALAM ANGKA] \
#text(9.5pt, style: "italic")[Sungai Pinyuh District in Figures] \
#text(9.5pt)[2026] \
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/_Catalogue_:*], [1102001.6104040],
  [*ISSN:*], [2477-6777],
  [*Nomor Publikasi/_Publication Number_:*], [61040.26011],
  [], [],
...
#text(8pt)[
  ...
  #v(5pt)
  Ucapan terima kasih dan penghargaan setinggi-tingginya disampaikan kepada Camat Sungai Pinyuh, para Kepala Desa/Lurah se-Kecamatan Sungai Pinyuh, serta pimpinan instansi dinas/lembaga atas koordinasi dan kontribusi data yang diberikan dalam penyusunan buku ini.
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Village Status Based on Developing Village Index (IDM) in Sungai Pinyuh Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Educational Units by Education Level in Sungai Pinyuh Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Principals and Teachers by Education Level in Sungai Pinyuh Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
...
#grid(
  ...
  [
    ...
    #v(-2pt)
    #text(6.5pt, weight: "bold", style: "italic", fill: rgb("#1E293B"))[Number of Students by Education Level in Sungai Pinyuh Subdistrict, 2024/2025]
  ]
)
#v(3pt)
#show table.cell: set par(justify: false)
