  ...
  header: context {
    ...
    if page_num >= 7 {
      if calc.even(page_num) {
        align(left, text(6.5pt, fill: rgb("#B45309"), weight: "bold")[KECAMATAN SUNGAI PINYUH DALAM ANGKA 2026])
      } else {
...
#grid(
  columns: (1fr, 1.2fr),
  row-gutter: 5pt,
  [*Katalog/Catalogue:*], [1102001.6104040],
  [*ISSN:*], [-],
  [*Nomor Publikasi/Publication Number:*], [61040.26011],
  [], [],
...
#grid(
  ...
  [
    #text(7.5pt)[
      Publikasi *Kecamatan Sungai Pinyuh Dalam Angka 2026* merupakan seri tahunan BPS Kabupaten Mempawah yang menyajikan beragam data dari BPS, kecamatan, kelurahan/desa, serta instansi terkait. Publikasi ini memuat gambaran umum mengenai geografi, pemerintahan, serta kondisi sosial demografi dan perekonomian di Kecamatan Sungai Pinyuh.
      ...
      Ucapan terima kasih disampaikan kepada Camat Sungai Pinyuh, para Lurah/Kepala Desa se-Kecamatan Sungai Pinyuh, serta seluruh pihak yang telah membantu dalam penyusunan publikasi ini. Kritik dan saran membangun sangat kami harapkan demi penyempurnaan edisi berikutnya.
    ]
  ],
  [
    #text(7.5pt, style: "italic")[
      *"Sungai Pinyuh District in Figures 2026"* is an annual series issued by BPS-Statistics of Mempawah Regency, presenting various data collected from BPS, subdistrict offices, villages/urban villages, and related regional agencies. This publication provides a comprehensive overview of geography, governance, as well as social, demographic, and economic conditions across villages in Sungai Pinyuh District.
      ...
      We express our sincere gratitude to the Head of Sungai Pinyuh District, village heads, and all collaborating institutions. Constructive feedback is warmly appreciated for continuous refinement.
    ]
  ]
)
